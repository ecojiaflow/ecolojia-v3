        ...
        <div className="prose prose-lg max-w-none text-[#3B3B3B]/80">
          ...
          <section className="mb-8">
            ...
            <div className="bg-[#7DDE4A]/5 p-6 rounded-xl mb-6 border border-[#7DDE4A]/20">
              ...
              <ul className="list-disc list-inside space-y-2 text-[#3B3B3B]/70">
                ...
                <li>Un assistant IA pour répondre ÃƒÆ’Ã‚Â  vos questions nutritionnelles</li>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-[#3B3B3B]">Vous vous engagez ÃƒÆ’Ã‚Â  :</h3>
              <ul className="list-disc list-inside space-y-2 text-[#3B3B3B]/70">
              ...
              <ul className="list-disc list-inside space-y-2 text-[#3B3B3B]/70">
                ...
                <li>Utiliser le service ÃƒÆ’Ã‚Â  des fins commerciales sans accord préalable</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-[#3B3B3B]/70">
              ...
              mise ÃƒÆ’Ã‚Â  jour ou en cas de force majeure, sans préavis.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-[#3B3B3B]/70 mb-4">
              ...
              sont protégés par le droit de la propriété intellectuelle et appartiennent ÃƒÆ’Ã‚Â  ECOLOJIA ou ses partenaires.
            </p>
            <p className="text-[#3B3B3B]/70">
              Toute reproduction, représentation ou exploitation non autorisée est interdite et 
              peut donner lieu ÃƒÆ’Ã‚Â  des poursuites judiciaires.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="bg-yellow-50 p-6 rounded-xl border border-yellow-200">
              <p className="text-[#3B3B3B]/70 mb-4">
                <strong>Important :</strong> Les informations fournies par ECOLOJIA sont ÃƒÆ’Ã‚Â  titre informatif uniquement.
              </p>
              <p className="text-[#3B3B3B]/70">
          ...
          <section className="border-t border-gray-200 pt-8">
            ...
            <p className="text-[#3B3B3B]/70">
              ...
              Tout litige relatif ÃƒÆ’Ã‚Â  leur interprétation ou exécution relève de la compétence 
