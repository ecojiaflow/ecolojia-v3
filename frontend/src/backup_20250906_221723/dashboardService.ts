...
class DashboardService {
  ...
  async getStats(): Promise<DashboardStats> {
    ...
    try {
      ...
      // Retourner des donnees mockees en cas d'erreur
      return mockService.getDashboardStats();
    }
  }

  /**
   * Recuperer les insights personnalises
   */
  async getPersonalizedInsights(): Promise<PersonalizedInsights> {
    try {
      ...
      // Retourner des donnees mockees
      return {
        recommendations: [
          {
            type: 'tip',
            title: 'Privilegiez les produits bio',
            description: 'Vous avez scanne 40% de produits bio ce mois-ci',
            icon: 'leaf'
          }
        ],
        goals: [
  ...
  /**
   * Recuperer l'analyse detaillee par periode
   */
  ...
  /**
   * Recuperer les produits tendance
   */
  ...
  /**
   * Recuperer les widgets personnalises du dashboard
   */
  ...
  /**
   * Recuperer les notifications du dashboard
   */
  ...
  /**
   * Exporter les donnees du dashboard
   */
