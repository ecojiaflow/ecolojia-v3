    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        {filteredIngredients.length === 0 ? (
          <p className="text-center text-gray-500 py-8">Aucun ingrédient trouvé</p>
        ) : (
                      ...
                      <div className="mt-2 flex flex-wrap gap-2">
                        ...
                        {ingredient.concerns.length > 0 && (
                          <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-orange-50 text-orange-700">
                            ...
                            {ingredient.concerns.length} préoccupation(s)
                          </span>
                        )}
                      </div>
                    )}
                ...
                {expandedIngredient === ingredient.position && (
                  ...
                  >
                    <div className="space-y-3">
                      ...
                      {ingredient.concerns.length > 0 && (
                        <div>
                          <h4 className="text-sm font-semibold text-gray-700 mb-1">Préoccupations</h4>
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        ...
                        {ingredient.allergen && (
                          <div>
                            <span className="font-semibold text-gray-700">Allergène :</span>
                        ...
                        {ingredient.comedogenic !== undefined && ingredient.comedogenic > 0 && (
                          <div>
                            <span className="font-semibold text-gray-700">Comédogène :</span>
                        ...
                        {ingredient.environmentalHazard && (
                          <div>
                            ...
                            <span className="ml-2 text-red-600">Négatif</span>
                          </div>
                        )}
                      </div>
                    </div>
      ...
      <div className="mt-6 p-4 bg-gray-50 rounded-lg">
        <p className="text-sm text-gray-600">
          <span className="font-medium">{filteredIngredients.length}</span> ingrédient(s) affiché(s) sur {ingredients.length} au total.
        </p>
        {filter === 'concerning' && filteredIngredients.length > 0 && (
          <p className="text-sm text-orange-600 mt-1">
            Ces ingrédients nécessitent une attention particulière selon votre type de peau et vos sensibilités.
          </p>
        )}
      </div>
    </div>
