...
const certificationData: Record<string, CertificationInfo> = {
  'cosmos_organic': {
    id: 'cosmos_organic',
    name: 'COSMOS Organic',
    description: 'Au moins 95% d\'ingrédients biologiques',
  ...
  'cosmos_natural': {
    id: 'cosmos_natural',
    name: 'COSMOS Natural',
    description: 'Cosmétique naturel certifié',
  ...
  'natrue': {
    id: 'natrue',
    name: 'NaTrue',
    description: 'Cosmétique naturel authentique',
    icon: <Leaf className="w-full h-full" />,
    color: 'text-lime-700',
    bgColor: 'bg-lime-100'
  },
  'bdih': {
    id: 'bdih',
    name: 'BDIH',
    description: 'Cosmétique naturel contrôlé',
  ...
  'organic': {
    id: 'organic',
    name: 'Bio',
    description: 'Ingrédients issus de l\'agriculture biologique',
  ...
  'dermatologically_tested': {
    ...
    name: 'Testé dermatologiquement',
    description: 'Testé sous contrôle dermatologique',
...
// Composant pour afficher un résumé des certifications
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      {categorizedCerts.organic.length > 0 && (
        <div className="text-center">
          ...
          <p className="text-sm font-medium">Certifié Bio</p>
