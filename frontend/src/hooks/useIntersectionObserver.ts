...
interface UseIntersectionObserverOptions {
  ...
  roota: Element | null;
  rootMargina: string;
  freezeOnceVisiblea: boolean;
}

export const useIntersectionObserver = (
  elementRef: React.RefObject<Element>,
  callback: (isIntersecting: boolean, entrya: IntersectionObserverEntry) => void,
  ...
  useEffect(() => {
    ...
    // Si freezeOnceVisible est active et l'element ? dej ete visible
    ...
    const handleIntersection = (entries: IntersectionObserverEntry[]) => {
      ...
      // Si freezeOnceVisible et maintenant visible, deconnecter l'observer
