          ...
          {blockedFeature && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
              <div className="flex items-center gap-2 text-red-700">
                ...
                <span className="font-medium">Fonctionnalite Premium</span>
              </div>
              <p className="text-sm text-red-600 mt-1">
                "{blockedFeature}" necessite un compte Premium
              </p>
            </div>
          )}
          ...
          <div className="space-y-3 mb-6">
            ...
            <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
              ...
              <div>
                ...
                <div className="text-sm text-blue-600">IA de raisonnement avance pour analyses expertes</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-orange-50 rounded-lg">
              ...
              <div>
                <div className="font-medium text-orange-800">Cot maitrise</div>
                <div className="text-sm text-orange-600">~0,02aaa par question aa {currentUsage.totalCost.toFixed(4)}aaa ce mois</div>
              </div>
            </div>
          </div>
      ...
      <div className="text-right">
        {userTier === 'free' ? (
          ...
          <div>
            ...
            <div className="text-xs mt-1">aaa {stats.totalCost.toFixed(4)}aaa</div>
          </div>
        )}
      </div>
    );
