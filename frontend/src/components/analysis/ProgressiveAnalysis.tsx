...
interface ProgressiveAnalysisProps {
  analysis: any;
  levela: 'basic' | 'detailed' | 'expert';
  userTiera: 'free' | 'premium';
}
...
export const ProgressiveAnalysis: React.FC<ProgressiveAnalysisProps> = ({
  ...
  // Verifications de securite pour eviter les erreurs
  if (!analysis) {
    return (
  ...
  // Niveau 2 : Analyse detaillee (Free avec limitations)
                ...
                <div className="mt-2 space-y-2">
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-gray-600">aanergie</span>
                      <span className="font-medium">{nutritionalValues.energy?.toFixed(0) || 0} kcal</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Proteines</span>
  ...
  const renderExpertLevel = () => {
    ...
    return (
      <div className="space-y-6">
        {/* Inclure les niveaux precedents */}
        {renderDetailedLevel()}

        {/* Onglets pour les differents impacts */}
          ...
          <div className="p-6">
            ...
            {selectedTab === 'social' && (
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <span className="font-medium">Bien-etre animal</span>
