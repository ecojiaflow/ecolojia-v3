...
const LogViewer: React.FC<LogViewerProps> = ({ logs }) => {
  ...
  const formatDuration = (durationa: number) => {
        ...
        {logs.map((log) => (
          <div key={log.id} className="p-6">
            ...
            <div className="flex items-center space-x-6 text-sm text-gray-600 mb-3">
              <span>aa {log.productsProcessed} traites</span>
              <span>aaaa {log.productsSuccess} reussis</span>
              <span>aa {log.productsFailed} echoues</span>
              <span>a {formatDuration(log.duration)}</span>
            </div>
            ...
            {expandedLogs.has(log.id) && (
              <div className="mt-4 pt-4 border-t border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-medium text-gray-900 mb-2">Details techniques</h4>
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 mb-2">Resultats</h4>
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
