...
const ThermoMeter = ({ 
  ...
  // Determiner la couleur selon la valeur
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        <defs>
          {/* Gradient vertical pour le thermometre */}
      ...
      <div className="mt-2 flex items-center space-x-2">
        ...
        <span className="text-xs text-gray-400">
          {fillPercentage <= 33 ? 'Optimal' : fillPercentage <= 66 ? 'Modere' : 'aleve'}
        </span>
      </div>
    </div>
  );
