...
const CookieBanner: React.FC = () => {
  ...
  useEffect(() => {
    // Verifier si l'utilisateur ? dej fait un choix
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 leading-relaxed">
                  Nous utilisons des cookies pour ameliorer votre experience et analyser notre trafic de maniere anonyme. 
                  ...
                  <div className="mt-3 space-y-2 text-xs">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-gray-700">
                        <strong>Cookies necessaires</strong> - Fonctionnement du site (toujours actifs)
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <input type="checkbox" defaultChecked className="w-3 h-3" />
                      <span className="text-gray-700">
                        <strong>Analytics</strong> - Plausible Analytics (respectueux de la vie privee)
                      </span>
                    </div>
                  </div>
                )}
          ...
          <div className="flex flex-col sm:flex-row gap-2 lg:flex-shrink-0">
            ...
            >
              {showDetails ? 'Masquer details' : 'Personnaliser'}
            </button>
