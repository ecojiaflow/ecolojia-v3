...
const Navbar: React.FC = () => {
  ...
  // Filtrer selon device
  console.log('ðŸ” isMobile:', isMobile, 'navigationItems:', navigationItems.map(i => i.name));
  const navigation = navigationItems.filter(item => {
    if (item.desktopOnly && isMobile) return false; // Masquer Multi-Scan mobile
    return true;
  });
