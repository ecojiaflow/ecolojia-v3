...
export const AnalysisLoadingStates = {
  ...
  searching: {
    ...
    message: "Consultation de notre base de donnees",
    duration: "~3 secondes"
  },
  analyzing: {
    icon: "",
    title: "Analyse IA en cours...",
    message: "Classification scientifique des ingredients",
    duration: "~5 secondes"
  },
  finalizing: {
    icon: "aa",
...
export const SmartLoading: React.FC<SmartLoadingProps> = ({ stage, progress, category }) => {
  ...
  const categoryMessages = {
    food: {
      analyzing: "Classification NOVA et detection ultra-transformation..."
    },
    cosmetics: {
      analyzing: "Detection perturbateurs endocriniens et allergenes..."
    },
    detergents: {
      analyzing: "aavaluation impact environnemental et toxicite..."
    }
  };
...
// Hook pour gerer la progression automatique
