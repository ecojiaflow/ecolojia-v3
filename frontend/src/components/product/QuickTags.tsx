...
export function QuickTags({ flags, nova, nutriScore, isBio }: QuickTagsProps) {
  ...
  // Ajouter NOVA si pertinent et pas déjà présent
  ...
  // Ajouter Nutri-Score si pertinent et pas déjà présent
  ...
  // Si aucun tag, ne pas afficher le bloc
  if (tags.length === 0) {
    return null;
  }
