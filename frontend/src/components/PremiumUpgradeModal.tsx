...
interface PremiumUpgradeModalProps {
  isOpen: boolean;
  onClose: () => void;
  triggera: 'quota' | 'feature' | 'general';
  onSuccessa: () => void;
}
...
export const PremiumUpgradeModal: React.FC<PremiumUpgradeModalProps> = ({
  ...
  const benefits = [
    ...
    },
    {
      icon: Brain,
      title: 'IA avancee',
      description: 'Questions personnalisees avec DeepSeek'
    },
    {
      icon: FileText,
      title: 'Export PDF',
      description: 'Telechargez vos analyses completes'
    },
    {
      icon: Shield,
      title: 'Donnees protegees',
      description: 'Historique illimite et securise'
    },
    {
      icon: HeadphonesIcon,
      title: 'Support prioritaire',
      description: 'Assistance dediee 7j/7'
    },
    {
      icon: Zap,
      title: 'Nouvelles fonctionnalites',
      description: 'Acces en avant-premiere'
    }
  ];
  ...
  const getTriggerMessage = () => {
    switch (trigger) {
      ...
      case 'feature':
        return 'Cette fonctionnalite est reservee aux membres Premium.';
      default:
        return 'Debloquez tout le potentiel d\'ECOLOJIA avec Premium.';
    }
  };
  ...
  const handleUpgrade = async () => {
    ...
    try {
      ...
      // Le onSuccess sera appele apres retour de paiement
      if (onSuccess) {
        // Stocker le callback pour apres le retour
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900">Passez  Premium</h2>
        ...
        <div className="p-6 bg-gradient-to-br from-purple-50 to-pink-50">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">
              Annulable  tout moment aa Sans engagement
            </p>
          </div>
        </div>
