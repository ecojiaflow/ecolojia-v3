...
export const QuotaAlert: React.FC<QuotaAlertProps> = ({
  ...
  useEffect(() => {
    // Auto-hide apres 10 secondes si c'est juste un warning
  ...
  const quotaInfo = {
    scans: {
      ...
      benefit: 'Analyses illimitees avec Premium',
      color: 'blue'
    },
    aiQuestions: {
      title: 'Questions IA',
      ...
      benefit: 'Chat IA illimite avec Premium',
      color: 'purple'
    },
    exports: {
      title: 'Exports de donnees',
      icon: 'aa',
      resetPeriod: 'ce mois-ci',
      benefit: 'Exports illimites avec Premium',
      color: 'green'
    }
  };
    ...
    <div className={`relative ${bgColor} ${borderColor} border rounded-lg p-4 mb-4 shadow-sm transition-all duration-300`}>
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex-1">
            <h3 className={`text-sm font-medium ${textColor}`}>
              {isExhausted 
                ? `Quota ${info.title.toLowerCase()} epuise`
                : `${remaining} ${info.title.toLowerCase()} restant(es)`
              }
            </h3>
            <p className={`text-sm ${textColor} opacity-90 mt-1`}>
              Vous avez utilise {currentUsage} sur {limit} {info.resetPeriod}
            </p>
          </div>
        </div>
      ...
      <div className="mt-3">
        ...
        <div className="flex justify-between text-xs mt-1">
          <span className={textColor}>{currentUsage} utilise(s)</span>
      ...
      <div className="mt-4 flex flex-col sm:flex-row gap-2">
        {isExhausted ? (
          ...
          <>
            ...
            >
              {showDetails ? 'Masquer details' : 'Voir les avantages Premium'}
            </button>
            {percentage >= 90 && (
              <button
                onClick={handleUpgrade}
          ...
          <div className="bg-white bg-opacity-50 rounded-lg p-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 mt-1">
                    Acces continu sans interruption
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 mt-1">
                    Dashboard avance, export PDF, priorite support
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-4 text-center">
              <p className="text-sm text-gray-700 mb-3">
                Seulement <span className="font-bold text-lg">2,49aaa</span>/mois
              </p>
              <button
                onClick={handleUpgrade}
