        ...
        <div className="prose prose-lg max-w-none text-neutral-800/80">
          ...
          <section className="mb-8">
            ...
            <div className="bg-primary/5 p-6 rounded-xl mb-6 border border-primary/20">
              <h3 className="text-lg font-semibold text-neutral-800 mb-3">ECOLOJIA propose :</h3>
              <ul className="list-disc list-inside space-y-2 text-neutral-800/70">
                ...
                <li>Un assistant IA pour repondre Æ’Ã†'' ââ‚¬â„¢Æ’ââ‚¬Å¡'šÃ‚Â  vos questions nutritionnelles</li>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-neutral-800">Vous vous engagez Æ’Ã†'' ââ‚¬â„¢Æ’ââ‚¬Å¡'šÃ‚Â  :</h3>
              <ul className="list-disc list-inside space-y-2 text-neutral-800/70">
              ...
              <h3 className="text-xl font-semibold text-neutral-800 mt-6">Il est interdit de :</h3>
              <ul className="list-disc list-inside space-y-2 text-neutral-800/70">
                ...
                <li>Utiliser le service Æ’Ã†'' ââ‚¬â„¢Æ’ââ‚¬Å¡'šÃ‚Â  des fins commerciales sans accord prealable</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-neutral-800/70">
              ...
              mise Æ’Ã†'' ââ‚¬â„¢Æ’ââ‚¬Å¡'šÃ‚Â  jour ou en cas de force majeure, sans preavis.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-neutral-800/70 mb-4">
              ...
              sont proteges par le droit de la propriete intellectuelle et appartiennent Æ’Ã†'' ââ‚¬â„¢Æ’ââ‚¬Å¡'šÃ‚Â  ECOLOJIA ou ses partenaires.
            </p>
            <p className="text-neutral-800/70">
              Toute reproduction, representation ou exploitation non autorisee est interdite et 
              peut donner lieu Æ’Ã†'' ââ‚¬â„¢Æ’ââ‚¬Å¡'šÃ‚Â  des poursuites judiciaires.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="bg-yellow-50 p-6 rounded-xl border border-yellow-200">
              <p className="text-neutral-800/70 mb-4">
                <strong>Important :</strong> Les informations fournies par ECOLOJIA sont Æ’Ã†'' ââ‚¬â„¢Æ’ââ‚¬Å¡'šÃ‚Â  titre informatif uniquement.
              </p>
              <p className="text-neutral-800/70">
          ...
          <section className="border-t border-gray-200 pt-8">
            ...
            <p className="text-neutral-800/70">
              ...
              Tout litige relatif Æ’Ã†'' ââ‚¬â„¢Æ’ââ‚¬Å¡'šÃ‚Â  leur interpretation ou execution releve de la competence 
