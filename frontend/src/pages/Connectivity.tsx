    ...
    <div>
      <div className="nav">
        <div className="nav-inner container">
          <div style={{ fontWeight: 800 }}>ECOLOJIA — Debug</div>
      ...
      <div className="container" style={{ marginTop: 16 }}>
        ...
        <p>Test e2e contre <code>/api/*</code> (DEV via proxy Vite, PROD via Netlify → Render).</p>
        ...
        <div className="row">
          ...
          <div className="card" style={{ gridColumn: 'span 6' }}>
            <div className="h2">OCR (photo → texte)</div>
          ...
          <Card className="" title="Logs (dernier en haut)" right={<span className="badge">{logs.length}</span>}>
            <div style={{ display: 'grid', gap: 10 }}>
              ...
              {logs.length === 0 && <div className="small">Clique sur les boutons ci‑dessus pour lancer les tests.</div>}
            </div>
          </Card>
        </div>
      </div>
