            ...
            <div>
              ...
              {barcodeValid && (
                <p className="text-xs text-primary mt-1">
                  aÆ’ââ‚¬Â¦aâ'šÂ¬Ã…'œaaââ‚¬Å¡Ã‚Â¬'šÃ‚Â¦ Code-barres detecte ({barcode.length} caracteres)
                </p>
              )}
              {!barcodeValid && (
                <p className="text-xs text-red-600 mt-1">
                  aÆ’ââ‚¬Â¦'šÃ‚Â¡Æ’ââ‚¬Å¡'šÃ‚Â Æ’Ã‚Â¯Æ’ââ‚¬Å¡'šÃ‚Â¸Æ’ââ‚¬Å¡'šÃ‚Â Code-barres manquant - Retournez scanner le produit
                </p>
              )}
            </div>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-eco-text mb-2">
              Aidez-nous Æ’Ã†'' ââ‚¬â„¢Æ’ââ‚¬Å¡'šÃ‚Â  enrichir notre base !
            </h2>
          ...
          >
            {isAnalyzing ? (
              ...
              <>
                <span>aÆ’ââ‚¬Å¡'šÃ‚ÂÆ’ââ‚¬Â¦aâ'šÂ¬â'žÂ¢ Code-barres requis</span>
              </>
            ) : (
              <>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ul className="text-sm text-blue-800 space-y-1">
            <li>aaââ‚¬Å¡Ã‚Â¬Æ’ââ‚¬Å¡'šÃ‚Â¢ Extraction automatique du nom et de la marque</li>
            <li>aaââ‚¬Å¡Ã‚Â¬Æ’ââ‚¬Å¡'šÃ‚Â¢ Reconnaissance OCR des ingredients</li>
            <li>aaââ‚¬Å¡Ã‚Â¬Æ’ââ‚¬Å¡'šÃ‚Â¢ calculédu score ecologique (0-100%)</li>
            <li>aaââ‚¬Å¡Ã‚Â¬Æ’ââ‚¬Å¡'šÃ‚Â¢ Creation automatique de la fiche produit</li>
          </ul>
        </div>
      </div>
    </div>
