    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div id="results-content" className="space-y-6">
          {/* Analyse specifique par categorie */}
              ...
              <ul className="space-y-2">
                {result.analysis.recommendations.map((rec, index) => (
                  <li key={index} className="flex items-start">
                    <span className="text-primary mr-2">aa'šÂ¬ƒ'š‚Â¢</span>
...
// Composant pour l'analyse cosmetique
const CosmeticsAnalysis: React.FC<{ analysis: any }> = ({ analysis }) => (
  <div className="bg-white rounded-xl shadow-sm p-6">
    <h2 className="text-xl font-semibold mb-4">Analyse Cosmetique</h2>
    ...
    {analysis.allergens && analysis.allergens.length > 0 && (
      <div className="mt-4">
        <h3 className="font-medium text-gray-900 mb-2">Allergenes</h3>
...
// Composant pour l'analyse detergents
      ...
      <div className="mt-4">
        ...
        <span className={`px-3 py-1 rounded text-sm ${
          ...
          {analysis.aquaticToxicity === 'low' ? 'Faible' :
           analysis.aquaticToxicity === 'medium' ? 'Moyenne' : 'ƒÆ’†'aa'šÂ¬‚Â°levee'}
        </span>
      </div>
    )}
  </div>
