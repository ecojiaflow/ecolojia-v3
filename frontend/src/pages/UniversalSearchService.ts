...
const UniversalSearchPage: React.FC = () => {
    ...
    >
        ...
        <div className="flex-1 pr-4">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            ...
            <span className={`px-3 py-1 rounded-full text-xs font-medium border ${
              ...
              {result.category === 'food' ? 'Æ’Ã†''šÃ‚Â°Æ’Ã¢â‚¬Â¦'šÃ‚Â¸Æ’Ã¢â‚¬Å¡'šÃ‚ÂÆ’Ã¢â‚¬Â¦'šÃ‚Â½ Alimentaire' :
               result.category === 'cosmetics' ? 'aÆ’Ã¢â‚¬Â¦aÃ¢'šÂ¬Ã…'œÆ’Ã¢â‚¬Å¡'šÃ‚Â¨ Cosmetique' :
               result.category === 'detergents' ? 'Æ’Ã†''šÃ‚Â°Æ’Ã¢â‚¬Â¦'šÃ‚Â¸Æ’Ã¢â‚¬Å¡'šÃ‚Â§Æ’Ã¢â‚¬Å¡'šÃ‚Â½ Detergent' : 'Æ’Ã†''šÃ‚Â°Æ’Ã¢â‚¬Â¦'šÃ‚Â¸aaÃ¢â‚¬Å¡Ã‚Â¬'¦Ã¢â‚¬Å“Æ’Ã¢â‚¬Å¡'šÃ‚Â¦ Produit'}
            </span>
            ...
            <span className={`px-3 py-1 rounded-full text-xs font-medium border ${
              ...
              {result.source === 'local' ? 'Æ’Ã†''šÃ‚Â°Æ’Ã¢â‚¬Â¦'šÃ‚Â¸Æ’Ã¢â‚¬Å¡'šÃ‚ÂÆ’Ã¢â‚¬Å¡'šÃ‚Â  Base ECOLOJIA' :
               ...
               'aÆ’Ã¢â‚¬Â¦'šÃ‚Â¡Æ’Ã¢â‚¬Å¡'šÃ‚Â¡ Algolia'}
            </span>
            ...
            {result.enrichment?.nova_group && (
              <span className={`px-3 py-1 rounded-full text-xs font-medium border ${
                ...
                Æ’Ã†''šÃ‚Â°Æ’Ã¢â‚¬Â¦'šÃ‚Â¸aaÃ¢â‚¬Å¡Ã‚Â¬'šÃ‚ÂÆ’Ã¢â‚¬Å¡'šÃ‚Â¬ NOVA {result.enrichment.nova_group}
                {result.enrichment.nova_group === 1 && ' aÆ’Ã¢â‚¬Â¦aÃ¢'šÂ¬Ã…'œÆ’Ã¢â‚¬Å¡'šÃ‚Â¨'}
                {result.enrichment.nova_group === 4 && ' aÆ’Ã¢â‚¬Â¦'šÃ‚Â¡Æ’Ã¢â‚¬Å¡'šÃ‚Â Æ’Ã‚Â¯Æ’Ã¢â‚¬Å¡'šÃ‚Â¸Æ’Ã¢â‚¬Å¡'šÃ‚Â'}
              </span>
            )}
            ...
            {result.enrichment?.ultra_processed && (
              <span className="px-3 py-1 bg-red-100 text-red-700 border border-red-200 rounded-full text-xs font-medium">
                aÆ’Ã¢â‚¬Â¦'šÃ‚Â¡Æ’Ã¢â‚¬Å¡'šÃ‚Â Æ’Ã‚Â¯Æ’Ã¢â‚¬Å¡'šÃ‚Â¸Æ’Ã¢â‚¬Å¡'šÃ‚Â Ultra-transforme
              </span>
            )}
          ...
          {result.enrichment?.educational_tips && result.enrichment.educational_tips.length > 0 && (
            <div className="mb-4">
              <div className="bg-orange-50 border border-orange-200 rounded-lg p-3">
                <div className="text-sm font-medium text-orange-800 mb-2">Æ’Ã†''šÃ‚Â°Æ’Ã¢â‚¬Â¦'šÃ‚Â¸aaÃ¢â‚¬Å¡Ã‚Â¬aÃ¢â‚¬Å¾Ã‚Â¢Æ’Ã¢â‚¬Å¡'šÃ‚Â¡ Insights ECOLOJIA :</div>
      ...
      <div className="flex justify-between items-center pt-4 border-t border-gray-100">
        <div className="text-xs text-gray-500">
          ID: {result.id}
          {result.barcode && ` aaÃ¢â‚¬Å¡Ã‚Â¬Æ’Ã¢â‚¬Å¡'šÃ‚Â¢ Code: ${result.barcode}`}
        </div>
        ...
        <div className="flex items-center space-x-2">
          <div className="px-3 py-1 bg-green-500 text-white rounded-lg text-sm font-medium hover:bg-green-600 transition-colors">
            Analyser ECOLOJIA aaaÃ¢â‚¬Å¡Ã‚Â¬'šÃ‚Â aaÃ¢â‚¬Å¡Ã‚Â¬aÃ¢â‚¬Å¾Ã‚Â¢
          </div>
        </div>
      </div>
    </div>
  ...
  const renderEmptyState = () => {
      ...
      return (
        <div className="text-center py-16">
          ...
          <div className="space-y-3">
            ...
            >
              Æ’Ã†''šÃ‚Â°Æ’Ã¢â‚¬Â¦'šÃ‚Â¸aaÃ¢â‚¬Å¡Ã‚Â¬'¦Ã¢â‚¬Å“Æ’Ã¢â‚¬Å¡'šÃ‚Â· Analyser avec photo des ingredients
            </button>
            <button
              onClick={() => {
            ...
            >
              aÆ’Ã¢â‚¬Â¦aÃ¢'šÂ¬Ã…'œÆ’Ã¢â‚¬Å¡'šÃ‚ÂÆ’Ã‚Â¯Æ’Ã¢â‚¬Å¡'šÃ‚Â¸Æ’Ã¢â‚¬Å¡'šÃ‚Â Ajouter manuellement ce produit
            </button>
          </div>
        </div>
      );
    ...
    return (
      <div className="text-center py-16">
        ...
        >
          Æ’Ã†''šÃ‚Â°Æ’Ã¢â‚¬Â¦'šÃ‚Â¸aaÃ¢â‚¬Å¡Ã‚Â¬'¦Ã¢â‚¬Å“Æ’Ã¢â‚¬Å¡'šÃ‚Â· Scanner un produit
        </button>
      </div>
    );
  };
      ...
      <div className="bg-gradient-to-r from-blue-50 to-green-50 border border-blue-200 rounded-xl p-6 mb-8">
        ...
        <div className="mt-4 p-4 bg-white rounded-lg border border-blue-200">
          <div className="text-sm text-blue-800">
            <strong>Æ’Ã†''šÃ‚Â°Æ’Ã¢â‚¬Â¦'šÃ‚Â¸aaÃ¢â‚¬Å¡Ã‚Â¬aÃ¢â‚¬Å¾Ã‚Â¢Æ’Ã¢â‚¬Å¡'šÃ‚Â¡ Conseil personnalise :</strong>{' '}
            {avgScore >= 80 ? 
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between mb-6">
            ...
            >
              ...
              Retour Æ’Ã†'' Ã¢â‚¬â„¢Æ’Ã¢â‚¬Å¡'šÃ‚Â  l'accueil
            </button>
            ...
            >
              Æ’Ã†''šÃ‚Â°Æ’Ã¢â‚¬Â¦'šÃ‚Â¸aaÃ¢â‚¬Å¡Ã‚Â¬'¦Ã¢â‚¬Å“Æ’Ã¢â‚¬Å¡'šÃ‚Â· Scanner
            </button>
          </div>

          {/* Interface de recherche */}
          <EnhancedSearchInterface
            placeholder="Æ’Ã†''šÃ‚Â°Æ’Ã¢â‚¬Â¦'šÃ‚Â¸aaÃ¢â‚¬Å¡Ã‚Â¬'šÃ‚ÂÆ’Ã¢â‚¬Å¡'šÃ‚Â Recherche universelle : nutella bio, shampoing sans sulfate, lessive ecologique..."
          ...
          {searchStats && (
            <div className="flex items-center justify-between text-sm text-gray-600">
              <div>
                ...
                aaÃ¢â‚¬Å¡Ã‚Â¬Æ’Ã¢â‚¬Å¡'šÃ‚Â¢ <span className="font-medium">{searchStats.searchTime}ms</span>
                aaÃ¢â‚¬Å¡Ã‚Â¬Æ’Ã¢â‚¬Å¡'šÃ‚Â¢ Sources: <span className="font-medium">{searchStats.sources.join(', ')}</span>
              </div>
          ...
          <div className="text-center py-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
              <div className="p-4 bg-white rounded-lg border border-gray-200">
                <div className="text-2xl mb-2">Æ’Ã†''šÃ‚Â°Æ’Ã¢â‚¬Â¦'šÃ‚Â¸Æ’Ã¢â‚¬Å¡'šÃ‚ÂÆ’Ã¢â‚¬Â¦'šÃ‚Â½</div>
                <div className="font-medium">Alimentaire</div>
                <div className="text-sm text-gray-600">NOVA, additifs, bio</div>
              </div>
              <div className="p-4 bg-white rounded-lg border border-gray-200">
                <div className="text-2xl mb-2">aÆ’Ã¢â‚¬Â¦aÃ¢'šÂ¬Ã…'œÆ’Ã¢â‚¬Å¡'šÃ‚Â¨</div>
                <div className="font-medium">Cosmetiques</div>
                <div className="text-sm text-gray-600">INCI, perturbateurs</div>
              </div>
              <div className="p-4 bg-white rounded-lg border border-gray-200">
                <div className="text-2xl mb-2">Æ’Ã†''šÃ‚Â°Æ’Ã¢â‚¬Â¦'šÃ‚Â¸Æ’Ã¢â‚¬Å¡'šÃ‚Â§Æ’Ã¢â‚¬Å¡'šÃ‚Â½</div>
                <div className="font-medium">Detergents</div>
                <div className="text-sm text-gray-600">Æ’Ã†'' Ã¢â‚¬â„¢aaÃ¢â‚¬Å¡Ã‚Â¬'šÃ‚Â°cologie, toxicite</div>
              </div>
            </div>
          </div>
        )}
      ...
      {/* Scanner modal - aÆ’Ã¢â‚¬Â¦aÃ¢'šÂ¬Ã…'œaaÃ¢â‚¬Å¡Ã‚Â¬'šÃ‚Â¦ Votre composant existant */}
      {showScanner && (
        <BarcodeScanner
          isOpen={showScanner}
