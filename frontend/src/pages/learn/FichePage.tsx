      ...
      <div className="min-h-screen bg-[#FAFAF7] grid place-items-center p-4">
        <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm">
          ...
          <button onClick={() => nav(-1)}
            className="mt-6 w-full rounded-xl px-5 py-3 text-sm font-semibold text-white bg-slate-800 hover:bg-slate-700 shadow-sm transition-all">
            Retour
          </button>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#FAFAF7]">
      ...
      <div className="mx-auto max-w-md px-4 py-6 space-y-5">
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <div className="mt-4 px-4 py-3 rounded-xl bg-violet-50/80 border border-violet-200 shadow-sm">
