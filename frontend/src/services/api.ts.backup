...
// Auth header depuis localStorage si prÃ©sent
...
// ðŸ”´ IMPORTANT : toutes les mÃ©thodes retournent .data
...
export const userService = {
  ...
  // Mettre Ã  jour le profil (nom, email, prÃ©fÃ©rencesâ€¦)
...
export const paymentService = {
  ...
  // Statut d'abonnement courant (active, trialing, canceledâ€¦)
  ...
  // Annuler l'abonnement (fin de pÃ©riode en gÃ©nÃ©ral)
  ...
  // RÃ©activer l'abonnement si supportÃ©
...
/** ---------- History Service (analyses rÃ©centes) ---------- */
export const historyService = {
  // Liste paginÃ©e des analyses (avec filtres optionnels)
  ...
  // Ajouter une entrÃ©e d'historique manuellement
  ...
  // Statistiques simples (si exposÃ©es par le backend)
  stats: async () => {
