...
// Utiliser l'API existante /api/analysis
export const productService = {
  analyze: (payload: { barcode?: string; category?: 'food'|'cosmetics'|'detergents'; name?: string }) =>
    api.post('/analysis', payload).then(r => r.data), // API existante
