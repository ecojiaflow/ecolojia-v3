export default {
  ...
  product: {
    ...
    confidence: {
      ...
      low: "Données insuffisantes - Score approximatif"
    },

    methodology: {
      title: "Méthodologie scientifique",
      description: "8 composantes pondérées selon leur impact Santé/environnement",
      sources: "Sources officielles : OMS, ANSES, EFSA, ADEME, Santé Publique France",
      version: "Version 3.0.0 - Calculé le {{date}}"
    }
  }
};
