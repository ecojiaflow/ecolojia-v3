...
export const CATEGORIES: Record<CategoryType, CategoryConfig> = {
  ...
  [CategoryType.COSMETIQUE]: {
    name: "Cosmetiques", 
    icon: "ƒÆ’‚Â°ƒ'¦‚Â¸aa'šÂ¬a'žÂ¢aa'šÂ¬…Â¾",
    color: "pink",
  ...
  [CategoryType.ELECTRONIQUE]: {
    name: "ƒÆ’†'aa'šÂ¬‚Â°lectronique",
    icon: "ƒÆ’‚Â°ƒ'¦‚Â¸aa'šÂ¬…'œƒ'š‚Â±",
    color: "purple",
