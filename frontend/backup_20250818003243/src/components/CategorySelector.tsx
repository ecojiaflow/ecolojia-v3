  ...
  const categories = [
    {
      ...
      examples: 'Plats prepares, boissons, snacks...',
      color: 'green',
      stats: '2M+ produits analyses'
    },
    {
      ...
      examples: 'Cremes, shampooings, maquillage...',
      color: 'pink',
    ...
    },
    {
      ...
      examples: 'Lessives, produits menagers...',
      color: 'blue',
      stats: '200K+ formules analysees'
    }
  ];
    ...
    <div className={`category-selector ${className}`}>
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">
          Quelle categorie souhaitez-vous analyser a
        </h2>
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              Notre intelligence artificielle adapte automatiquement ses criteres d'analyse selon la categorie :
              <span className="font-medium"> Classification NOVA</span> pour l'alimentaire,
              <span className="font-medium"> analyse INCI</span> pour les cosmetiques,
              <span className="font-medium"> impact environnemental</span> pour les detergents.
            </p>
          </div>
        </div>
      </div>
