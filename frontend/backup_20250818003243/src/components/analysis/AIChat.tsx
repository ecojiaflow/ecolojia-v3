  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      type: 'assistant',
      content: productData ? 
        `Bonjour ! Je suis votre assistant IA specialise en analyse scientifique. Je peux vous expliquer tout sur "${productDat?.name}" : composition, impact sante, alternatives, etc. Que souhaitez-vous savoir a` :
