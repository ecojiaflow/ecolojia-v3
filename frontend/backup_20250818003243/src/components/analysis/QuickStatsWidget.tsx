...
/**
 * aa QuickStatsWidget - Apercu Analytics pour HomePage
...
const QuickStatsWidget: React.FC = () => {
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 border border-purple-200">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600 text-sm">
            Analysez vos premiers produits pour debloquer vos statistiques
          </p>
        </div>
  ...
  // aavolution score (derniers 7 jours vs precedents)
    ...
    <div className="bg-white rounded-xl shadow-lg p-6 border border-purple-200">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600 text-sm">
            Apercu de vos progres nutrition
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-lg text-center">
          ...
          <p className="text-xs text-blue-700 font-medium">Analyses</p>
          <p className="text-xs text-blue-600 mt-1">realisees</p>
        </div>
      ...
      <div className="space-y-2">
        ...
        >
          aa Analyser un nouveau produit
        </button>
      </div>
