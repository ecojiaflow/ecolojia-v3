        ...
        <div className="prose prose-lg max-w-none text-[#3B3B3B]/80">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[#3B3B3B]/70">
                  Chez ECOLOJIA, nous nous engageons Æ’Ã†â€™â€ Ã¢â‚¬â„¢Æ’Ã¢â‚¬Å¡â€šÃ‚Â  proteger votre vie privee et vos donnees personnelles. 
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2 text-[#3B3B3B]/70">
              ...
              <li>Repondre Æ’Ã†â€™â€ Ã¢â‚¬â„¢Æ’Ã¢â‚¬Å¡â€šÃ‚Â  vos questions et demandes de support</li>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p className="text-[#3B3B3B]/70">
                  Nous aident Æ’Ã†â€™â€ Ã¢â‚¬â„¢Æ’Ã¢â‚¬Å¡â€šÃ‚Â  comprendre comment vous utilisez ECOLOJIA (anonymises)
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2 text-[#3B3B3B]/70">
              <li>Droit d'acces Æ’Ã†â€™â€ Ã¢â‚¬â„¢Æ’Ã¢â‚¬Å¡â€šÃ‚Â  vos donnees personnelles</li>
              <li>Droit de rectification des donnees inexactes</li>
              <li>Droit Æ’Ã†â€™â€ Ã¢â‚¬â„¢Æ’Ã¢â‚¬Å¡â€šÃ‚Â  l'effacement (droit Æ’Ã†â€™â€ Ã¢â‚¬â„¢Æ’Ã¢â‚¬Å¡â€šÃ‚Â  l'oubli)</li>
              <li>Droit Æ’Ã†â€™â€ Ã¢â‚¬â„¢Æ’Ã¢â‚¬Å¡â€šÃ‚Â  la limitation du traitement</li>
              <li>Droit Æ’Ã†â€™â€ Ã¢â‚¬â„¢Æ’Ã¢â‚¬Å¡â€šÃ‚Â  la portabilite des donnees</li>
              <li>Droit d'opposition au traitement</li>
              <li>Droit de retirer votre consentement Æ’Ã†â€™â€ Ã¢â‚¬â„¢Æ’Ã¢â‚¬Å¡â€šÃ‚Â  tout moment</li>
            </ul>
          </section>
          ...
          <section className="border-t border-gray-200 pt-8">
            ...
            <p className="text-[#3B3B3B]/70">
              Nous pouvons mettre Æ’Ã†â€™â€ Ã¢â‚¬â„¢Æ’Ã¢â‚¬Å¡â€šÃ‚Â  jour cette politique de confidentialite. 
              Les modifications importantes seront notifiees par email ou via l'application.
              Nous vous encourageons Æ’Ã†â€™â€ Ã¢â‚¬â„¢Æ’Ã¢â‚¬Å¡â€šÃ‚Â  consulter regulierement cette page.
            </p>
          </section>
        </div>
      </div>
