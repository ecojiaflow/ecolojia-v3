...
import BarcodeScanner from '../components/scanner/BarcodeScanner'; // aÆ’Ã¢â‚¬Â¦aÃ¢â€šÂ¬Ã…â€œaaÃ¢â‚¬Å¡Ã‚Â¬â€šÃ‚Â¦ Votre scanner existant
...
const UniversalSearchPage: React.FC = () => {
  ...
  const handleSearch = useCallback(async (query: string) => {
    ...
    try {
      console.log('Æ’Ã†â€™â€šÃ‚Â°Æ’Ã¢â‚¬Â¦â€šÃ‚Â¸aaÃ¢â‚¬Å¡Ã‚Â¬â€šÃ‚ÂÆ’Ã¢â‚¬Å¡â€šÃ‚Â Recherche universelle lancee:', query);
      ...
      // Mettre Æ’Ã†â€™â€ Ã¢â‚¬â„¢Æ’Ã¢â‚¬Å¡â€šÃ‚Â  jour URL sans reload
      setSearchParams({ q: query });

      console.log(`aÆ’Ã¢â‚¬Â¦aÃ¢â€šÂ¬Ã…â€œaaÃ¢â‚¬Å¡Ã‚Â¬â€šÃ‚Â¦ Recherche terminee: ${filteredResults.length}/${searchResults.length} resultats en ${searchTime}ms`);
  ...
  const handleScanSuccess = useCallback(async (barcode: string) => {
    ...
    try {
      ...
      console.error('aÆ’Ã¢â‚¬Å¡â€šÃ‚ÂÆ’Ã¢â‚¬Â¦aÃ¢â€šÂ¬Ã¢â€žÂ¢ Erreur scan:', error);
    }
  }, [setSearchParams]);
    ...
    >
        ...
        <div className="flex-1 pr-4">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            ...
            <span className={`px-3 py-1 rounded-full text-xs font-medium border ${
              ...
              {result.source === 'local' ? 'Æ’Ã†â€™â€šÃ‚Â°Æ’Ã¢â‚¬Â¦â€šÃ‚Â¸Æ’Ã¢â‚¬Å¡â€šÃ‚ÂÆ’Ã¢â‚¬Å¡â€šÃ‚Â  Base ECOLOJIA' :
            ...
            {result.enrichment?.nova_group && (
              <span className={`px-3 py-1 rounded-full text-xs font-medium border ${
                ...
                Æ’Ã†â€™â€šÃ‚Â°Æ’Ã¢â‚¬Â¦â€šÃ‚Â¸aaÃ¢â‚¬Å¡Ã‚Â¬â€šÃ‚ÂÆ’Ã¢â‚¬Å¡â€šÃ‚Â¬ NOVA {result.enrichment.nova_group}
                {result.enrichment.nova_group === 1 && ' aÆ’Ã¢â‚¬Â¦aÃ¢â€šÂ¬Ã…â€œÆ’Ã¢â‚¬Å¡â€šÃ‚Â¨'}
                {result.enrichment.nova_group === 4 && ' aÆ’Ã¢â‚¬Â¦â€šÃ‚Â¡Æ’Ã¢â‚¬Å¡â€šÃ‚Â Æ’Ã‚Â¯Æ’Ã¢â‚¬Å¡â€šÃ‚Â¸Æ’Ã¢â‚¬Å¡â€šÃ‚Â'}
              </span>
            )}
          ...
          {result.enrichment?.educational_tips && result.enrichment.educational_tips.length > 0 && (
            <div className="mb-4">
              <div className="bg-orange-50 border border-orange-200 rounded-lg p-3">
                <div className="text-sm font-medium text-orange-800 mb-2">Æ’Ã†â€™â€šÃ‚Â°Æ’Ã¢â‚¬Â¦â€šÃ‚Â¸aaÃ¢â‚¬Å¡Ã‚Â¬aÃ¢â‚¬Å¾Ã‚Â¢Æ’Ã¢â‚¬Å¡â€šÃ‚Â¡ Insights ECOLOJIA :</div>
      ...
      <div className="flex justify-between items-center pt-4 border-t border-gray-100">
        <div className="text-xs text-gray-500">
          ID: {result.id}
          {result.barcode && ` aaÃ¢â‚¬Å¡Ã‚Â¬Æ’Ã¢â‚¬Å¡â€šÃ‚Â¢ Code: ${result.barcode}`}
        </div>
        ...
        <div className="flex items-center space-x-2">
          <div className="px-3 py-1 bg-green-500 text-white rounded-lg text-sm font-medium hover:bg-green-600 transition-colors">
            Analyser ECOLOJIA aaaÃ¢â‚¬Å¡Ã‚Â¬â€šÃ‚Â aaÃ¢â‚¬Å¡Ã‚Â¬aÃ¢â‚¬Å¾Ã‚Â¢
          </div>
        </div>
      </div>
    </div>
  ...
  const renderEmptyState = () => {
    if (searchStats?.query.includes('Code-barres')) {
      return (
        <div className="text-center py-16">
          ...
          <h3 className="text-xl font-bold text-gray-800 mb-3">Produit non trouve</h3>
          <p className="text-gray-600 mb-6">
            Le code-barres scanne n'est pas encore dans notre base de donnees.
          </p>
          <div className="space-y-3">
            ...
            >
              Æ’Ã†â€™â€šÃ‚Â°Æ’Ã¢â‚¬Â¦â€šÃ‚Â¸aaÃ¢â‚¬Å¡Ã‚Â¬â€¦Ã¢â‚¬Å“Æ’Ã¢â‚¬Å¡â€šÃ‚Â· Analyser avec photo des ingredients
            </button>
            <button
              onClick={() => {
            ...
            >
              aÆ’Ã¢â‚¬Â¦aÃ¢â€šÂ¬Ã…â€œÆ’Ã¢â‚¬Å¡â€šÃ‚ÂÆ’Ã‚Â¯Æ’Ã¢â‚¬Å¡â€šÃ‚Â¸Æ’Ã¢â‚¬Å¡â€šÃ‚Â Ajouter manuellement ce produit
            </button>
          </div>
        </div>
      );
    ...
    return (
      <div className="text-center py-16">
        ...
        <h3 className="text-xl font-bold text-gray-800 mb-3">Aucun resultat trouve</h3>
        <p className="text-gray-600 mb-6">
          Essayez des mots-cles differents ou scannez un code-barres.
        </p>
        <button
          onClick={() => setShowScanner(true)}
          className="px-6 py-3 bg-green-500 text-white rounded-xl font-medium hover:bg-green-600 transition-colors"
        >
          Æ’Ã†â€™â€šÃ‚Â°Æ’Ã¢â‚¬Â¦â€šÃ‚Â¸aaÃ¢â‚¬Å¡Ã‚Â¬â€¦Ã¢â‚¬Å“Æ’Ã¢â‚¬Å¡â€šÃ‚Â· Scanner un produit
        </button>
      </div>
    );
  };
      ...
      <div className="bg-gradient-to-r from-blue-50 to-green-50 border border-blue-200 rounded-xl p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="text-center">
            ...
            <div className="text-gray-600">Produits trouves</div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="text-gray-600">Ultra-transformes</div>
          </div>
        ...
        <div className="mt-4 p-4 bg-white rounded-lg border border-blue-200">
          <div className="text-sm text-blue-800">
            <strong>Æ’Ã†â€™â€šÃ‚Â°Æ’Ã¢â‚¬Â¦â€šÃ‚Â¸aaÃ¢â‚¬Å¡Ã‚Â¬aÃ¢â‚¬Å¾Ã‚Â¢Æ’Ã¢â‚¬Å¡â€šÃ‚Â¡ Conseil personnalise :</strong>{' '}
            {avgScore >= 80 ? 
              "Excellente selection ! Vous privilegiez des produits sains." :
              avgScore >= 60 ? 
              "Selection correcte. Essayez de privilegier les produits bio ou moins transformes." :
              "Beaucoup de produits transformes. Filtrez par 'Bio uniquement' pour de meilleures alternatives."
            }
          </div>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          <EnhancedSearchInterface
            placeholder="Æ’Ã†â€™â€šÃ‚Â°Æ’Ã¢â‚¬Â¦â€šÃ‚Â¸aaÃ¢â‚¬Å¡Ã‚Â¬â€šÃ‚ÂÆ’Ã¢â‚¬Å¡â€šÃ‚Â Recherche universelle : nutella bio, shampoing sans sulfate, lessive ecologique..."
          ...
          {searchStats && (
            <div className="flex items-center justify-between text-sm text-gray-600">
              <div>
                <span className="font-medium">{searchStats.totalResults}</span> resultats pour "
                <span className="font-medium">{searchStats.query}</span>" 
                aaÃ¢â‚¬Å¡Ã‚Â¬Æ’Ã¢â‚¬Å¡â€šÃ‚Â¢ <span className="font-medium">{searchStats.searchTime}ms</span>
                aaÃ¢â‚¬Å¡Ã‚Â¬Æ’Ã¢â‚¬Å¡â€šÃ‚Â¢ Sources: <span className="font-medium">{searchStats.sources.join(', ')}</span>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {results.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 mb-6">
              Recherchez parmi des milliers de produits depuis Algolia, OpenFoodFacts et notre base ECOLOJI?.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
              <div className="p-4 bg-white rounded-lg border border-gray-200">
                <div className="text-2xl mb-2">Æ’Ã†â€™â€šÃ‚Â°Æ’Ã¢â‚¬Â¦â€šÃ‚Â¸Æ’Ã¢â‚¬Å¡â€šÃ‚ÂÆ’Ã¢â‚¬Â¦â€šÃ‚Â½</div>
                <div className="font-medium">Alimentaire</div>
                <div className="text-sm text-gray-600">NOVA, additifs, bio</div>
              </div>
              <div className="p-4 bg-white rounded-lg border border-gray-200">
                <div className="text-2xl mb-2">aÆ’Ã¢â‚¬Â¦aÃ¢â€šÂ¬Ã…â€œÆ’Ã¢â‚¬Å¡â€šÃ‚Â¨</div>
                <div className="font-medium">Cosmetiques</div>
                <div className="text-sm text-gray-600">INCI, perturbateurs</div>
              </div>
              <div className="p-4 bg-white rounded-lg border border-gray-200">
                <div className="text-2xl mb-2">Æ’Ã†â€™â€šÃ‚Â°Æ’Ã¢â‚¬Â¦â€šÃ‚Â¸Æ’Ã¢â‚¬Å¡â€šÃ‚Â§Æ’Ã¢â‚¬Å¡â€šÃ‚Â½</div>
                <div className="font-medium">Detergents</div>
                <div className="text-sm text-gray-600">Æ’Ã†â€™â€ Ã¢â‚¬â„¢aaÃ¢â‚¬Å¡Ã‚Â¬â€šÃ‚Â°cologie, toxicite</div>
              </div>
            </div>
          </div>
        )}
      ...
      {/* Scanner modal - aÆ’Ã¢â‚¬Â¦aÃ¢â€šÂ¬Ã…â€œaaÃ¢â‚¬Å¡Ã‚Â¬â€šÃ‚Â¦ Votre composant existant */}
      {showScanner && (
        <BarcodeScanner
          isOpen={showScanner}
