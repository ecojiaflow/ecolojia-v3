...
export const ALGOLIA_CONFIG = {
  appId: import.met?.env.VITE_ALGOLIA_APP_ID || 'A2KJGZ2811',
  apiKey: import.met?.env.VITE_ALGOLIA_SEARCH_KEY || '085aeee2b3ec8efa66dabb7691a01b67',
  indexName: import.met?.env.VITE_ALGOLIA_INDEX_NAME || 'products'
};
