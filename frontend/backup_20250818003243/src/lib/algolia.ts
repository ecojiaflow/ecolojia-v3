...
const ALGOLIA_SEARCH_KEY = import.met?.env.VITE_ALGOLIA_SEARCH_KEY || '085aeee2b3ec8efa66dabb7691a01b67';
export const ALGOLIA_INDEX_NAME = import.met?.env.VITE_ALGOLIA_INDEX_NAME || 'products';
