...
export const AuthPage: React.FC<AuthPageProps> = ({ defaultMode = 'login' }) => {
  ...
  const handleStartDemo = async () => {
    try {
      ...
      // Verifier si startDemoMode existe
      if (typeof startDemoMode !== 'function') {
        console.error('aa startDemoMode non disponible');
        // Fallback: activer le mode demo manuellement
        ...
        const demoUser = {
          ...
          profile: {
            ...
            lastName: 'Demo',
            avatar: 'https://ui-avatars.com/api/aname=Demo+User&background=7DDE4A&color=fff'
          },
      ...
      console.error('aa Erreur activation mode demo:', error);
      setDemoError('Impossible d\'activer le mode demo. Veuillez reessayer.');
    }
  };
  ...
  const features = [
    {
      icon: Heart,
      title: 'Sante',
      description: 'Analysez l\'impact des produits sur votre sante'
    },
    {
      icon: Leaf,
      title: 'Environnement',
      description: 'Decouvrez l\'empreinte ecologique de vos achats'
    },
    {
      icon: Shield,
      title: 'Transparence',
      description: 'Accedez  des informations verifiees et sourcees'
    }
  ];
          ...
          >
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-600">
                Votre guide pour une consommation eclairee et responsable
              </p>
            </div>
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4 className="font-semibold text-[#3B3B3B]">
                  Essayez le mode demo
                </h4>
              </div>
              <p className="text-sm text-gray-600 mb-4">
                Decouvrez toutes les fonctionnalites d'ECOLOJIA sans creer de compte
              </p>
              <button
