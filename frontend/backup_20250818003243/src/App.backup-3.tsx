...
// aƒâ€¦aâ‚¬Å“aaâ€šÂ¬‚Â¦ Import direct des pages principales qui existent
...
// aƒâ€¦aâ‚¬Å“aaâ€šÂ¬‚Â¦ Pages legales
import AboutPage from './pages/AboutPage';
import PrivacyPage from './pages/PrivacyPage';
import TermsPage from './pages/TermsPage';

// aƒâ€¦aâ‚¬Å“aaâ€šÂ¬‚Â¦ Composant de chargement
const PageLoader = () => (
  <div className="min-h-screen bg-gray-50 flex items-center justify-center">
    <div className="text-center">
      <div className="text-6xl mb-4 animate-pulse">ƒÆ’‚Â°ƒâ€¦‚Â¸ƒâ€¦aâ‚¬â„¢ƒâ€š‚Â±</div>
      <p className="text-gray-600">Chargement...</p>
    </div>
  </div>
);

// aƒâ€¦aâ‚¬Å“aaâ€šÂ¬‚Â¦ Layout simple avec navigation
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <Link to="/" className="flex items-center space-x-2">
            <span className="text-2xl">ƒÆ’‚Â°ƒâ€¦‚Â¸ƒâ€¦aâ‚¬â„¢ƒâ€š‚Â±</span>
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-wrap justify-between items-center">
          <div className="text-gray-600 text-sm">
            ƒÆ’aâ‚¬Å¡‚Â© 2025 ECOLOJIA - L'assistant IA pour une consommation consciente
          </div>
          <div className="flex space-x-4 text-sm">
            <Link to="/about" className="text-gray-600 hover:text-green-600">ƒÆ’†â€™aâ€šÂ¬ propos</Link>
...
// aƒâ€¦aâ‚¬Å“aaâ€šÂ¬‚Â¦ Page Premium simple
const PremiumPage = () => (
  <div className="min-h-screen bg-gray-50 py-12">
    <div className="max-w-4xl mx-auto px-4">
      <div className="bg-white rounded-xl p-8 shadow-sm text-center">
        <h1 className="text-3xl font-bold text-gray-800 mb-6">aƒâ€š‚Â­ƒâ€š‚Â ECOLOJIA Premium</h1>
        <p className="text-xl text-gray-600 mb-8">
          Debloquez toutes les fonctionnalites avancees
        </p>
        <div className="grid md:grid-cols-2 gap-6">
          <div className="p-6 bg-gray-50 rounded-lg">
            <h3 className="text-lg font-semibold mb-4">ƒÆ’‚Â°ƒâ€¦‚Â¸aaâ€šÂ¬‚Â aaâ€šÂ¬…â€œ Gratuit</h3>
            <div className="text-3xl font-bold mb-4">0aaaâ€šÂ¬…Â¡ƒâ€š‚Â¬</div>
            <ul className="text-left space-y-2 text-sm">
              <li>aƒâ€¦aâ‚¬Å“aaâ€šÂ¬‚Â¦ 30 scans/mois</li>
              <li>aƒâ€¦aâ‚¬Å“aaâ€šÂ¬‚Â¦ Analyse complete IA</li>
              <li>aƒâ€¦aâ‚¬Å“aaâ€šÂ¬‚Â¦ 3 categories de produits</li>
              <li>aƒâ€š‚Âƒâ€¦aâ‚¬â„¢ Chat IA illimite</li>
              <li>aƒâ€š‚Âƒâ€¦aâ‚¬â„¢ Export de donnees</li>
            </ul>
          </div>
          <div className="p-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border-2 border-purple-200">
            <h3 className="text-lg font-semibold mb-4 text-purple-800">aƒâ€š‚Â­ƒâ€š‚Â Premium</h3>
            <div className="text-3xl font-bold mb-1">2,49aaaâ€šÂ¬…Â¡ƒâ€š‚Â¬</div>
            <div className="text-sm text-gray-600 mb-4">par mois</div>
            <ul className="text-left space-y-2 text-sm">
              <li>aƒâ€¦aâ‚¬Å“aaâ€šÂ¬‚Â¦ Scans illimites</li>
              <li>aƒâ€¦aâ‚¬Å“aaâ€šÂ¬‚Â¦ Chat IA illimite</li>
              <li>aƒâ€¦aâ‚¬Å“aaâ€šÂ¬‚Â¦ Dashboard avance</li>
              <li>aƒâ€¦aâ‚¬Å“aaâ€šÂ¬‚Â¦ Export PDF/Excel</li>
              <li>aƒâ€¦aâ‚¬Å“aaâ€šÂ¬‚Â¦ Support prioritaire</li>
            </ul>
            <button className="w-full mt-4 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg font-semibold hover:shadow-lg">
              ƒÆ’‚Â°ƒâ€¦‚Â¸ƒâ€¦‚Â¡aâ€šÂ¬ Essai gratuit 7 jours
            </button>
          </div>
        </div>
      </div>
...
// aƒâ€¦aâ‚¬Å“aaâ€šÂ¬‚Â¦ Page 404 amelioree
const NotFoundPage = () => (
  <div className="min-h-screen bg-gray-50 flex items-center justify-center">
    <div className="text-center">
      <div className="text-8xl mb-4">ƒÆ’‚Â°ƒâ€¦‚Â¸ƒâ€š‚Â¤aaâ€šÂ¬‚Â</div>
...
// aƒâ€¦aâ‚¬Å“aaâ€šÂ¬‚Â¦ APPLICATION PRINCIPALE
const App: React.FC = () => {
  return (
    <Router>
      <Layout>
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route path="/search" element={<HomePage />} /> {/* HomePage ? dejƒÆ’†â€™ƒâ€š‚Â  une recherche */}
            ...
            {/* ===== CATƒÆ’†â€™aaâ€šÂ¬‚Â°GORIES SPƒÆ’†â€™aaâ€šÂ¬‚Â°CIFIQUES ===== */}
