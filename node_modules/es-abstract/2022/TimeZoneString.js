...
module.exports = function TimeZoneString(tv) {
	...
	// 2. If offset is +0ð”½ or offset > +0ð”½, then
	//   a. Let offsetSign be "+".
	//   b. Let absOffset be offset.
	// 3. Else,
	//   a. Let offsetSign be "-".
	//   b. Let absOffset be -offset.
	// 4. Let offsetMin be ToZeroPaddedDecimalString(â„(MinFromTime(absOffset)), 2).
	// 5. Let offsetHour be ToZeroPaddedDecimalString(â„(HourFromTime(absOffset)), 2).
