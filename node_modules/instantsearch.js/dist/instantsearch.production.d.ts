...
declare type AnalyticsWidgetParams = {
     ...
     * current page, even if the delay wasnâ€™t reached.
     *
     * @default false
     */
     ...
     * the `pushFunction` might be called even though the user didnâ€™t perfom
...
declare type InfiniteHitsCSSClasses = Partial<{
    ...
    item: string | string[];
    /**
     * The â€œShow previousâ€ button.
     */
    loadPrevious: string | string[];
    /**
     * The disabled â€œShow previousâ€ button.
     */
    disabledLoadPrevious: string | string[];
    /**
     * The â€œShow moreâ€ button.
     */
    loadMore: string | string[];
    /**
     * The disabled â€œShow moreâ€ button.
     */
...
declare type InfiniteHitsTemplates<THit extends NonNullable<object> = BaseHit> = Partial<{
    ...
    empty: Template<SearchResults<THit>>;
    /**
     * The template to use for the â€œShow previousâ€ label.
     */
    showPreviousText: Template;
    /**
     * The template to use for the â€œShow moreâ€ label.
     */
    showMoreText: Template;
    /**
