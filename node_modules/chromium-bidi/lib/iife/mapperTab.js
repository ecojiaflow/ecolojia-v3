(function () {
    ...
    class MapperCdpConnection {
        static LOGGER_PREFIX_RECV = `${LogType.cdp}:RECV â—‚`;
        static LOGGER_PREFIX_SEND = `${LogType.cdp}:SEND â–¸`;
    ...
    class WindowBidiTransport {
        static LOGGER_PREFIX_RECV = `${LogType.bidi}:RECV â—‚`;
        static LOGGER_PREFIX_SEND = `${LogType.bidi}:SEND â–¸`;
