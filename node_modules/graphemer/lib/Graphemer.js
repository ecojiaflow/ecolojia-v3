        ...
        if (code < 0x27b0) {
            if (code < 0x2600) {
                if (code < 0x2328) {
                    if (code < 0x2122) {
                        if (code < 0x203c) {
                            // E0.6   [1] (Â©ï¸)       copyright
                            if (0xa9 === code) {
                                return boundaries_1.EXTENDED_PICTOGRAPHIC;
                            }
                            // E0.6   [1] (Â®ï¸)       registered
                            if (0xae === code) {
                                return boundaries_1.EXTENDED_PICTOGRAPHIC;
                            }
                        }
                        else {
                            // E0.6   [1] (â€¼ï¸)       double exclamation mark
                            if (0x203c === code) {
                                return boundaries_1.EXTENDED_PICTOGRAPHIC;
                            }
                            // E0.6   [1] (â‰ï¸)       exclamation question mark
                            if (0x2049 === code) {
                                return boundaries_1.EXTENDED_PICTOGRAPHIC;
                            }
                        }
                        ...
                        if (code < 0x2194) {
                            // E0.6   [1] (â„¢ï¸)       trade mark
                            if (0x2122 === code) {
                                return boundaries_1.EXTENDED_PICTOGRAPHIC;
                            }
                            // E0.6   [1] (â„¹ï¸)       information
                            if (0x2139 === code) {
                                return boundaries_1.EXTENDED_PICTOGRAPHIC;
                            }
                        }
                            ...
                            if (code < 0x21a9) {
                                // E0.6   [6] (â†”ï¸..â†™ï¸)    left-right arrow..down-left arrow
                                ...
                                if (code < 0x231a) {
                                    // E0.6   [2] (â†©ï¸..â†ªï¸)    right arrow curving left..left arrow curving right
                                    if (0x21a9 <= code && code <= 0x21aa) {
                                        return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                    }
                                }
                                else {
                                    // E0.6   [2] (âŒš..âŒ›)    watch..hourglass done
                    ...
                    if (code < 0x24c2) {
                        if (code < 0x23cf) {
                            // E1.0   [1] (âŒ¨ï¸)       keyboard
                            if (0x2328 === code) {
                                return boundaries_1.EXTENDED_PICTOGRAPHIC;
                            }
                            // E0.0   [1] (âŽˆ)       HELM SYMBOL
                            if (0x2388 === code) {
                                return boundaries_1.EXTENDED_PICTOGRAPHIC;
                            }
                        }
                            ...
                            if (code < 0x23e9) {
                                ...
                                if (code < 0x23f8) {
                                    // E0.6   [4] (â©..â¬)    fast-forward button..fast down button
                                    // E0.7   [2] (â­ï¸..â®ï¸)    next track button..last track button
                                    // E1.0   [1] (â¯ï¸)       play or pause button
                                    // E0.6   [1] (â°)       alarm clock
                                    // E1.0   [2] (â±ï¸..â²ï¸)    stopwatch..timer clock
                                    // E0.6   [1] (â³)       hourglass not done
                                    if (0x23e9 <= code && code <= 0x23f3) {
                                        return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                    }
                                }
                                else {
                                    // E0.7   [3] (â¸ï¸..âºï¸)    pause button..record button
                        ...
                        if (code < 0x25b6) {
                            if (code < 0x25aa) {
                                // E0.6   [1] (â“‚ï¸)       circled M
                                if (0x24c2 === code) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                            }
                            else {
                                // E0.6   [2] (â–ªï¸..â–«ï¸)    black small square..white small square
                            ...
                            if (code < 0x25c0) {
                                ...
                                if (code < 0x25fb) {
                                    // E0.6   [1] (â—€ï¸)       reverse button
                                    if (0x25c0 === code) {
                                        return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                    }
                                }
                                else {
                                    // E0.6   [4] (â—»ï¸..â—¾)    white medium square..black medium-small square
                ...
                if (code < 0x2733) {
                    if (code < 0x2714) {
                        if (code < 0x2614) {
                            if (code < 0x2607) {
                                // E0.6   [2] (â˜€ï¸..â˜ï¸)    sun..cloud
                                // E0.7   [2] (â˜‚ï¸..â˜ƒï¸)    umbrella..snowman
                                // E1.0   [1] (â˜„ï¸)       comet
                                // E0.0   [1] (â˜…)       BLACK STAR
                                ...
                                // E0.0   [7] (â˜‡..â˜)    LIGHTNING..OPPOSITION
                                // E0.6   [1] (â˜Žï¸)       telephone
                                // E0.0   [2] (â˜..â˜)    WHITE TELEPHONE..BALLOT BOX
                                // E0.6   [1] (â˜‘ï¸)       check box with check
                                // E0.0   [1] (â˜’)       BALLOT BOX WITH X
                            ...
                            if (code < 0x2690) {
                                // E0.6   [2] (â˜”..â˜•)    umbrella with rain drops..hot beverage
                                // E0.0   [2] (â˜–..â˜—)    WHITE SHOGI PIECE..BLACK SHOGI PIECE
                                // E1.0   [1] (â˜˜ï¸)       shamrock
                                // E0.0   [4] (â˜™..â˜œ)    REVERSED ROTATED FLORAL HEART BULLET..WHITE LEFT POINTING INDEX
                                // E0.6   [1] (â˜ï¸)       index pointing up
                                // E0.0   [2] (â˜ž..â˜Ÿ)    WHITE RIGHT POINTING INDEX..WHITE DOWN POINTING INDEX
                                // E1.0   [1] (â˜ ï¸)       skull and crossbones
                                // E0.0   [1] (â˜¡)       CAUTION SIGN
                                // E1.0   [2] (â˜¢ï¸..â˜£ï¸)    radioactive..biohazard
                                // E0.0   [2] (â˜¤..â˜¥)    CADUCEUS..ANKH
                                // E1.0   [1] (â˜¦ï¸)       orthodox cross
                                // E0.0   [3] (â˜§..â˜©)    CHI RHO..CROSS OF JERUSALEM
                                // E0.7   [1] (â˜ªï¸)       star and crescent
                                // E0.0   [3] (â˜«..â˜­)    FARSI SYMBOL..HAMMER AND SICKLE
                                // E1.0   [1] (â˜®ï¸)       peace symbol
                                // E0.7   [1] (â˜¯ï¸)       yin yang
                                // E0.0   [8] (â˜°..â˜·)    TRIGRAM FOR HEAVEN..TRIGRAM FOR EARTH
                                // E0.7   [2] (â˜¸ï¸..â˜¹ï¸)    wheel of dharma..frowning face
                                // E0.6   [1] (â˜ºï¸)       smiling face
                                // E0.0   [5] (â˜»..â˜¿)    BLACK SMILING FACE..MERCURY
                                // E4.0   [1] (â™€ï¸)       female sign
                                // E0.0   [1] (â™)       EARTH
                                // E4.0   [1] (â™‚ï¸)       male sign
                                // E0.0   [5] (â™ƒ..â™‡)    JUPITER..PLUTO
                                // E0.6  [12] (â™ˆ..â™“)    Aries..Pisces
                                // E0.0  [11] (â™”..â™ž)    WHITE CHESS KING..BLACK CHESS KNIGHT
                                // E11.0  [1] (â™Ÿï¸)       chess pawn
                                // E0.6   [1] (â™ ï¸)       spade suit
                                // E0.0   [2] (â™¡..â™¢)    WHITE HEART SUIT..WHITE DIAMOND SUIT
                                // E0.6   [1] (â™£ï¸)       club suit
                                // E0.0   [1] (â™¤)       WHITE SPADE SUIT
                                // E0.6   [2] (â™¥ï¸..â™¦ï¸)    heart suit..diamond suit
                                // E0.0   [1] (â™§)       WHITE CLUB SUIT
                                // E0.6   [1] (â™¨ï¸)       hot springs
                                // E0.0  [18] (â™©..â™º)    QUARTER NOTE..RECYCLING SYMBOL FOR GENERIC MATERIALS
                                // E0.6   [1] (â™»ï¸)       recycling symbol
                                // E0.0   [2] (â™¼..â™½)    RECYCLED PAPER SYMBOL..PARTIALLY-RECYCLED PAPER SYMBOL
                                // E11.0  [1] (â™¾ï¸)       infinity
                                // E0.6   [1] (â™¿)       wheelchair symbol
                                // E0.0   [6] (âš€..âš…)    DIE FACE-1..DIE FACE-6
                                ...
                                if (code < 0x2708) {
                                    // E0.0   [2] (âš..âš‘)    WHITE FLAG..BLACK FLAG
                                    // E1.0   [1] (âš’ï¸)       hammer and pick
                                    // E0.6   [1] (âš“)       anchor
                                    // E1.0   [1] (âš”ï¸)       crossed swords
                                    // E4.0   [1] (âš•ï¸)       medical symbol
                                    // E1.0   [2] (âš–ï¸..âš—ï¸)    balance scale..alembic
                                    // E0.0   [1] (âš˜)       FLOWER
                                    // E1.0   [1] (âš™ï¸)       gear
                                    // E0.0   [1] (âšš)       STAFF OF HERMES
                                    // E1.0   [2] (âš›ï¸..âšœï¸)    atom symbol..fleur-de-lis
                                    // E0.0   [3] (âš..âšŸ)    OUTLINED WHITE STAR..THREE LINES CONVERGING LEFT
                                    // E0.6   [2] (âš ï¸..âš¡)    warning..high voltage
                                    // E0.0   [5] (âš¢..âš¦)    DOUBLED FEMALE SIGN..MALE WITH STROKE SIGN
                                    // E13.0  [1] (âš§ï¸)       transgender symbol
                                    // E0.0   [2] (âš¨..âš©)    VERTICAL MALE WITH STROKE SIGN..HORIZONTAL MALE WITH STROKE SIGN
                                    // E0.6   [2] (âšª..âš«)    white circle..black circle
                                    // E0.0   [4] (âš¬..âš¯)    MEDIUM SMALL WHITE CIRCLE..UNMARRIED PARTNERSHIP SYMBOL
                                    // E1.0   [2] (âš°ï¸..âš±ï¸)    coffin..funeral urn
                                    // E0.0  [11] (âš²..âš¼)    NEUTER..SESQUIQUADRATE
                                    // E0.6   [2] (âš½..âš¾)    soccer ball..baseball
                                    // E0.0   [5] (âš¿..â›ƒ)    SQUARED KEY..BLACK DRAUGHTS KING
                                    // E0.6   [2] (â›„..â›…)    snowman without snow..sun behind cloud
                                    // E0.0   [2] (â›†..â›‡)    RAIN..BLACK SNOWMAN
                                    // E0.7   [1] (â›ˆï¸)       cloud with lightning and rain
                                    // E0.0   [5] (â›‰..â›)    TURNED WHITE SHOGI PIECE..DISABLED CAR
                                    // E0.6   [1] (â›Ž)       Ophiuchus
                                    // E0.7   [1] (â›ï¸)       pick
                                    // E0.0   [1] (â›)       CAR SLIDING
                                    // E0.7   [1] (â›‘ï¸)       rescue workerâ€™s helmet
                                    // E0.0   [1] (â›’)       CIRCLED CROSSING LANES
                                    // E0.7   [1] (â›“ï¸)       chains
                                    // E0.6   [1] (â›”)       no entry
                                    // E0.0  [20] (â›•..â›¨)    ALTERNATE ONE-WAY LEFT WAY TRAFFIC..BLACK CROSS ON SHIELD
                                    // E0.7   [1] (â›©ï¸)       shinto shrine
                                    // E0.6   [1] (â›ª)       church
                                    // E0.0   [5] (â›«..â›¯)    CASTLE..MAP SYMBOL FOR LIGHTHOUSE
                                    // E0.7   [2] (â›°ï¸..â›±ï¸)    mountain..umbrella on ground
                                    // E0.6   [2] (â›²..â›³)    fountain..flag in hole
                                    // E0.7   [1] (â›´ï¸)       ferry
                                    // E0.6   [1] (â›µ)       sailboat
                                    // E0.0   [1] (â›¶)       SQUARE FOUR CORNERS
                                    // E0.7   [3] (â›·ï¸..â›¹ï¸)    skier..person bouncing ball
                                    // E0.6   [1] (â›º)       tent
                                    // E0.0   [2] (â›»..â›¼)    JAPANESE BANK SYMBOL..HEADSTONE GRAVEYARD SYMBOL
                                    // E0.6   [1] (â›½)       fuel pump
                                    // E0.0   [4] (â›¾..âœ)    CUP ON BLACK SQUARE..UPPER BLADE SCISSORS
                                    // E0.6   [1] (âœ‚ï¸)       scissors
                                    // E0.0   [2] (âœƒ..âœ„)    LOWER BLADE SCISSORS..WHITE SCISSORS
                                    // E0.6   [1] (âœ…)       check mark button
                                    if (0x2690 <= code && code <= 0x2705) {
                                        return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                    }
                                }
                                else {
                                    // E0.6   [5] (âœˆï¸..âœŒï¸)    airplane..victory hand
                                    // E0.7   [1] (âœï¸)       writing hand
                                    // E0.0   [1] (âœŽ)       LOWER RIGHT PENCIL
                                    // E0.6   [1] (âœï¸)       pencil
                                    // E0.0   [2] (âœ..âœ‘)    UPPER RIGHT PENCIL..WHITE NIB
                                    // E0.6   [1] (âœ’ï¸)       black nib
                        ...
                        if (code < 0x271d) {
                            // E0.6   [1] (âœ”ï¸)       check mark
                            if (0x2714 === code) {
                                return boundaries_1.EXTENDED_PICTOGRAPHIC;
                            }
                            // E0.6   [1] (âœ–ï¸)       multiply
                            if (0x2716 === code) {
                                return boundaries_1.EXTENDED_PICTOGRAPHIC;
                            }
                        }
                            ...
                            if (code < 0x2721) {
                                // E0.7   [1] (âœï¸)       latin cross
                                if (0x271d === code) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                            }
                            else {
                                // E0.7   [1] (âœ¡ï¸)       star of David
                                if (0x2721 === code) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                                // E0.6   [1] (âœ¨)       sparkles
                    ...
                    if (code < 0x2753) {
                        if (code < 0x2747) {
                            if (code < 0x2744) {
                                // E0.6   [2] (âœ³ï¸..âœ´ï¸)    eight-spoked asterisk..eight-pointed star
                                if (0x2733 <= code && code <= 0x2734) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                            }
                            else {
                                // E0.6   [1] (â„ï¸)       snowflake
                                if (0x2744 === code) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                            }
                            ...
                            if (code < 0x274c) {
                                ...
                                // E0.6   [1] (âŒ)       cross mark
                                if (0x274c === code) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                                // E0.6   [1] (âŽ)       cross mark button
                                if (0x274e === code) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                            }
                        ...
                        if (code < 0x2763) {
                            if (code < 0x2757) {
                                // E0.6   [3] (â“..â•)    red question mark..white exclamation mark
                                if (0x2753 <= code && code <= 0x2755) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                            }
                            else {
                                // E0.6   [1] (â—)       red exclamation mark
                                if (0x2757 === code) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                            }
                            ...
                            if (code < 0x2795) {
                                // E1.0   [1] (â£ï¸)       heart exclamation
                                // E0.6   [1] (â¤ï¸)       red heart
                                // E0.0   [3] (â¥..â§)    ROTATED HEAVY BLACK HEART BULLET..ROTATED FLORAL HEART BULLET
            ...
            if (code < 0x1f201) {
                if (code < 0x3297) {
                    if (code < 0x2b1b) {
                        if (code < 0x2934) {
                            // E0.6   [1] (âž°)       curly loop
                            if (0x27b0 === code) {
                                return boundaries_1.EXTENDED_PICTOGRAPHIC;
                            }
                            // E1.0   [1] (âž¿)       double curly loop
                            if (0x27bf === code) {
                                return boundaries_1.EXTENDED_PICTOGRAPHIC;
                            }
                        }
                            ...
                            if (code < 0x2b05) {
                                // E0.6   [2] (â¤´ï¸..â¤µï¸)    right arrow curving up..right arrow curving down
                                if (0x2934 <= code && code <= 0x2935) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                            }
                            else {
                                // E0.6   [3] (â¬…ï¸..â¬‡ï¸)    left arrow..down arrow
                        ...
                        if (code < 0x2b55) {
                            if (code < 0x2b50) {
                                // E0.6   [2] (â¬›..â¬œ)    black large square..white large square
                            ...
                            if (code < 0x3030) {
                                // E0.6   [1] (â­•)       hollow red circle
                                if (0x2b55 === code) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                            }
                            else {
                                // E0.6   [1] (ã€°ï¸)       wavy dash
                                if (0x3030 === code) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                                // E0.6   [1] (ã€½ï¸)       part alternation mark
                                if (0x303d === code) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                            }
                    ...
                    if (code < 0x1f16c) {
                        if (code < 0x1f000) {
                            // E0.6   [1] (ãŠ—ï¸)       Japanese â€œcongratulationsâ€ button
                            if (0x3297 === code) {
                                return boundaries_1.EXTENDED_PICTOGRAPHIC;
                            }
                            // E0.6   [1] (ãŠ™ï¸)       Japanese â€œsecretâ€ button
                            if (0x3299 === code) {
                                return boundaries_1.EXTENDED_PICTOGRAPHIC;
                            }
                        }
                            ...
                            if (code < 0x1f10d) {
                                // E0.0   [4] (ðŸ€€..ðŸ€ƒ)    MAHJONG TILE EAST WIND..MAHJONG TILE NORTH WIND
                                // E0.6   [1] (ðŸ€„)       mahjong red dragon
                                // E0.0 [202] (ðŸ€…..ðŸƒŽ)    MAHJONG TILE GREEN DRAGON..PLAYING CARD KING OF DIAMONDS
                                // E0.6   [1] (ðŸƒ)       joker
                                // E0.0  [48] (ðŸƒ..ðŸƒ¿)    <reserved-1F0D0>..<reserved-1F0FF>
                                ...
                                if (code < 0x1f12f) {
                                    // E0.0   [3] (ðŸ„..ðŸ„)    CIRCLED ZERO WITH SLASH..CIRCLED DOLLAR SIGN WITH OVERLAID BACKSLASH
                                    if (0x1f10d <= code && code <= 0x1f10f) {
                                        return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                    }
                                }
                                else {
                                    // E0.0   [1] (ðŸ„¯)       COPYLEFT SYMBOL
                                    if (0x1f12f === code) {
                                        return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                    }
                                }
                        ...
                        if (code < 0x1f18e) {
                            if (code < 0x1f17e) {
                                // E0.0   [4] (ðŸ…¬..ðŸ…¯)    RAISED MR SIGN..CIRCLED HUMAN FIGURE
                                // E0.6   [2] (ðŸ…°ï¸..ðŸ…±ï¸)    A button (blood type)..B button (blood type)
                                if (0x1f16c <= code && code <= 0x1f171) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                            }
                            else {
                                // E0.6   [2] (ðŸ…¾ï¸..ðŸ…¿ï¸)    O button (blood type)..P button
                            ...
                            if (code < 0x1f191) {
                                // E0.6   [1] (ðŸ†Ž)       AB button (blood type)
                                if (0x1f18e === code) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                            }
                                ...
                                if (code < 0x1f1ad) {
                                    // E0.6  [10] (ðŸ†‘..ðŸ†š)    CL button..VS button
                                    if (0x1f191 <= code && code <= 0x1f19a) {
                                        return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                    }
                                }
                                else {
                                    // E0.0  [57] (ðŸ†­..ðŸ‡¥)    MASK WORK SYMBOL..<reserved-1F1E5>
                ...
                if (code < 0x1f7d5) {
                    if (code < 0x1f249) {
                        if (code < 0x1f22f) {
                            if (code < 0x1f21a) {
                                // E0.6   [2] (ðŸˆ..ðŸˆ‚ï¸)    Japanese â€œhereâ€ button..Japanese â€œservice chargeâ€ button
                                // E0.0  [13] (ðŸˆƒ..ðŸˆ)    <reserved-1F203>..<reserved-1F20F>
                                if (0x1f201 <= code && code <= 0x1f20f) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                            }
                            else {
                                // E0.6   [1] (ðŸˆš)       Japanese â€œfree of chargeâ€ button
                                if (0x1f21a === code) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                            }
                            ...
                            if (code < 0x1f232) {
                                // E0.6   [1] (ðŸˆ¯)       Japanese â€œreservedâ€ button
                                if (0x1f22f === code) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                            }
                                ...
                                if (code < 0x1f23c) {
                                    // E0.6   [9] (ðŸˆ²..ðŸˆº)    Japanese â€œprohibitedâ€ button..Japanese â€œopen for businessâ€ button
                                    if (0x1f232 <= code && code <= 0x1f23a) {
                                        return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                    }
                                }
                                else {
                                    // E0.0   [4] (ðŸˆ¼..ðŸˆ¿)    <reserved-1F23C>..<reserved-1F23F>
                        ...
                        if (code < 0x1f546) {
                            if (code < 0x1f400) {
                                // E0.0   [7] (ðŸ‰‰..ðŸ‰)    <reserved-1F249>..<reserved-1F24F>
                                // E0.6   [2] (ðŸ‰..ðŸ‰‘)    Japanese â€œbargainâ€ button..Japanese â€œacceptableâ€ button
                                // E0.0 [174] (ðŸ‰’..ðŸ‹¿)    <reserved-1F252>..<reserved-1F2FF>
                                // E0.6  [13] (ðŸŒ€..ðŸŒŒ)    cyclone..milky way
                                // E0.7   [2] (ðŸŒ..ðŸŒŽ)    globe showing Europe-Africa..globe showing Americas
                                // E0.6   [1] (ðŸŒ)       globe showing Asia-Australia
                                // E1.0   [1] (ðŸŒ)       globe with meridians
                                // E0.6   [1] (ðŸŒ‘)       new moon
                                // E1.0   [1] (ðŸŒ’)       waxing crescent moon
                                // E0.6   [3] (ðŸŒ“..ðŸŒ•)    first quarter moon..full moon
                                // E1.0   [3] (ðŸŒ–..ðŸŒ˜)    waning gibbous moon..waning crescent moon
                                // E0.6   [1] (ðŸŒ™)       crescent moon
                                // E1.0   [1] (ðŸŒš)       new moon face
                                // E0.6   [1] (ðŸŒ›)       first quarter moon face
                                // E0.7   [1] (ðŸŒœ)       last quarter moon face
                                // E1.0   [2] (ðŸŒ..ðŸŒž)    full moon face..sun with face
                                // E0.6   [2] (ðŸŒŸ..ðŸŒ )    glowing star..shooting star
                                // E0.7   [1] (ðŸŒ¡ï¸)       thermometer
                                // E0.0   [2] (ðŸŒ¢..ðŸŒ£)    BLACK DROPLET..WHITE SUN
                                // E0.7   [9] (ðŸŒ¤ï¸..ðŸŒ¬ï¸)    sun behind small cloud..wind face
                                // E1.0   [3] (ðŸŒ­..ðŸŒ¯)    hot dog..burrito
                                // E0.6   [2] (ðŸŒ°..ðŸŒ±)    chestnut..seedling
                                // E1.0   [2] (ðŸŒ²..ðŸŒ³)    evergreen tree..deciduous tree
                                // E0.6   [2] (ðŸŒ´..ðŸŒµ)    palm tree..cactus
                                // E0.7   [1] (ðŸŒ¶ï¸)       hot pepper
                                // E0.6  [20] (ðŸŒ·..ðŸŠ)    tulip..tangerine
                                // E1.0   [1] (ðŸ‹)       lemon
                                // E0.6   [4] (ðŸŒ..ðŸ)    banana..green apple
                                // E1.0   [1] (ðŸ)       pear
                                // E0.6  [43] (ðŸ‘..ðŸ»)    peach..clinking beer mugs
                                // E1.0   [1] (ðŸ¼)       baby bottle
                                // E0.7   [1] (ðŸ½ï¸)       fork and knife with plate
                                // E1.0   [2] (ðŸ¾..ðŸ¿)    bottle with popping cork..popcorn
                                // E0.6  [20] (ðŸŽ€..ðŸŽ“)    ribbon..graduation cap
                                // E0.0   [2] (ðŸŽ”..ðŸŽ•)    HEART WITH TIP ON THE LEFT..BOUQUET OF FLOWERS
                                // E0.7   [2] (ðŸŽ–ï¸..ðŸŽ—ï¸)    military medal..reminder ribbon
                                // E0.0   [1] (ðŸŽ˜)       MUSICAL KEYBOARD WITH JACKS
                                // E0.7   [3] (ðŸŽ™ï¸..ðŸŽ›ï¸)    studio microphone..control knobs
                                // E0.0   [2] (ðŸŽœ..ðŸŽ)    BEAMED ASCENDING MUSICAL NOTES..BEAMED DESCENDING MUSICAL NOTES
                                // E0.7   [2] (ðŸŽžï¸..ðŸŽŸï¸)    film frames..admission tickets
                                // E0.6  [37] (ðŸŽ ..ðŸ„)    carousel horse..person surfing
                                // E1.0   [1] (ðŸ…)       sports medal
                                // E0.6   [1] (ðŸ†)       trophy
                                // E1.0   [1] (ðŸ‡)       horse racing
                                // E0.6   [1] (ðŸˆ)       american football
                                // E1.0   [1] (ðŸ‰)       rugby football
                                // E0.6   [1] (ðŸŠ)       person swimming
                                // E0.7   [4] (ðŸ‹ï¸..ðŸŽï¸)    person lifting weights..racing car
                                // E1.0   [5] (ðŸ..ðŸ“)    cricket game..ping pong
                                // E0.7  [12] (ðŸ”ï¸..ðŸŸï¸)    snow-capped mountain..stadium
                                // E0.6   [4] (ðŸ ..ðŸ£)    house..Japanese post office
                                // E1.0   [1] (ðŸ¤)       post office
                                // E0.6  [12] (ðŸ¥..ðŸ°)    hospital..castle
                                // E0.0   [2] (ðŸ±..ðŸ²)    WHITE PENNANT..BLACK PENNANT
                                // E0.7   [1] (ðŸ³ï¸)       white flag
                                // E1.0   [1] (ðŸ´)       black flag
                                // E0.7   [1] (ðŸµï¸)       rosette
                                // E0.0   [1] (ðŸ¶)       BLACK ROSETTE
                                // E0.7   [1] (ðŸ·ï¸)       label
                                // E1.0   [3] (ðŸ¸..ðŸº)    badminton..amphora
                                if (0x1f249 <= code && code <= 0x1f3fa) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                            }
                            else {
                                // E1.0   [8] (ðŸ€..ðŸ‡)    rat..rabbit
                                // E0.7   [1] (ðŸˆ)       cat
                                // E1.0   [3] (ðŸ‰..ðŸ‹)    dragon..whale
                                // E0.6   [3] (ðŸŒ..ðŸŽ)    snail..horse
                                // E1.0   [2] (ðŸ..ðŸ)    ram..goat
                                // E0.6   [2] (ðŸ‘..ðŸ’)    ewe..monkey
                                // E1.0   [1] (ðŸ“)       rooster
                                // E0.6   [1] (ðŸ”)       chicken
                                // E0.7   [1] (ðŸ•)       dog
                                // E1.0   [1] (ðŸ–)       pig
                                // E0.6  [19] (ðŸ—..ðŸ©)    boar..poodle
                                // E1.0   [1] (ðŸª)       camel
                                // E0.6  [20] (ðŸ«..ðŸ¾)    two-hump camel..paw prints
                                // E0.7   [1] (ðŸ¿ï¸)       chipmunk
                                // E0.6   [1] (ðŸ‘€)       eyes
                                // E0.7   [1] (ðŸ‘ï¸)       eye
                                // E0.6  [35] (ðŸ‘‚..ðŸ‘¤)    ear..bust in silhouette
                                // E1.0   [1] (ðŸ‘¥)       busts in silhouette
                                // E0.6   [6] (ðŸ‘¦..ðŸ‘«)    boy..woman and man holding hands
                                // E1.0   [2] (ðŸ‘¬..ðŸ‘­)    men holding hands..women holding hands
                                // E0.6  [63] (ðŸ‘®..ðŸ’¬)    police officer..speech balloon
                                // E1.0   [1] (ðŸ’­)       thought balloon
                                // E0.6   [8] (ðŸ’®..ðŸ’µ)    white flower..dollar banknote
                                // E1.0   [2] (ðŸ’¶..ðŸ’·)    euro banknote..pound banknote
                                // E0.6  [52] (ðŸ’¸..ðŸ“«)    money with wings..closed mailbox with raised flag
                                // E0.7   [2] (ðŸ“¬..ðŸ“­)    open mailbox with raised flag..open mailbox with lowered flag
                                // E0.6   [1] (ðŸ“®)       postbox
                                // E1.0   [1] (ðŸ“¯)       postal horn
                                // E0.6   [5] (ðŸ“°..ðŸ“´)    newspaper..mobile phone off
                                // E1.0   [1] (ðŸ“µ)       no mobile phones
                                // E0.6   [2] (ðŸ“¶..ðŸ“·)    antenna bars..camera
                                // E1.0   [1] (ðŸ“¸)       camera with flash
                                // E0.6   [4] (ðŸ“¹..ðŸ“¼)    video camera..videocassette
                                // E0.7   [1] (ðŸ“½ï¸)       film projector
                                // E0.0   [1] (ðŸ“¾)       PORTABLE STEREO
                                // E1.0   [4] (ðŸ“¿..ðŸ”‚)    prayer beads..repeat single button
                                // E0.6   [1] (ðŸ”ƒ)       clockwise vertical arrows
                                // E1.0   [4] (ðŸ”„..ðŸ”‡)    counterclockwise arrows button..muted speaker
                                // E0.7   [1] (ðŸ”ˆ)       speaker low volume
                                // E1.0   [1] (ðŸ”‰)       speaker medium volume
                                // E0.6  [11] (ðŸ”Š..ðŸ””)    speaker high volume..bell
                                // E1.0   [1] (ðŸ”•)       bell with slash
                                // E0.6  [22] (ðŸ”–..ðŸ”«)    bookmark..water pistol
                                // E1.0   [2] (ðŸ”¬..ðŸ”­)    microscope..telescope
                                // E0.6  [16] (ðŸ”®..ðŸ”½)    crystal ball..downwards button
                            ...
                            if (code < 0x1f680) {
                                // E0.0   [3] (ðŸ•†..ðŸ•ˆ)    WHITE LATIN CROSS..CELTIC CROSS
                                // E0.7   [2] (ðŸ•‰ï¸..ðŸ•Šï¸)    om..dove
                                // E1.0   [4] (ðŸ•‹..ðŸ•Ž)    kaaba..menorah
                                // E0.0   [1] (ðŸ•)       BOWL OF HYGIEIA
                                // E0.6  [12] (ðŸ•..ðŸ•›)    one oâ€™clock..twelve oâ€™clock
                                // E0.7  [12] (ðŸ•œ..ðŸ•§)    one-thirty..twelve-thirty
                                // E0.0   [7] (ðŸ•¨..ðŸ•®)    RIGHT SPEAKER..BOOK
                                // E0.7   [2] (ðŸ•¯ï¸..ðŸ•°ï¸)    candle..mantelpiece clock
                                // E0.0   [2] (ðŸ•±..ðŸ•²)    BLACK SKULL AND CROSSBONES..NO PIRACY
                                // E0.7   [7] (ðŸ•³ï¸..ðŸ•¹ï¸)    hole..joystick
                                // E3.0   [1] (ðŸ•º)       man dancing
                                // E0.0  [12] (ðŸ•»..ðŸ–†)    LEFT HAND TELEPHONE RECEIVER..PEN OVER STAMPED ENVELOPE
                                // E0.7   [1] (ðŸ–‡ï¸)       linked paperclips
                                // E0.0   [2] (ðŸ–ˆ..ðŸ–‰)    BLACK PUSHPIN..LOWER LEFT PENCIL
                                // E0.7   [4] (ðŸ–Šï¸..ðŸ–ï¸)    pen..crayon
                                // E0.0   [2] (ðŸ–Ž..ðŸ–)    LEFT WRITING HAND..TURNED OK HAND SIGN
                                // E0.7   [1] (ðŸ–ï¸)       hand with fingers splayed
                                // E0.0   [4] (ðŸ–‘..ðŸ–”)    REVERSED RAISED HAND WITH FINGERS SPLAYED..REVERSED VICTORY HAND
                                // E1.0   [2] (ðŸ–•..ðŸ––)    middle finger..vulcan salute
                                // E0.0  [13] (ðŸ–—..ðŸ–£)    WHITE DOWN POINTING LEFT HAND INDEX..BLACK DOWN POINTING BACKHAND INDEX
                                // E3.0   [1] (ðŸ–¤)       black heart
                                // E0.7   [1] (ðŸ–¥ï¸)       desktop computer
                                // E0.0   [2] (ðŸ–¦..ðŸ–§)    KEYBOARD AND MOUSE..THREE NETWORKED COMPUTERS
                                // E0.7   [1] (ðŸ–¨ï¸)       printer
                                // E0.0   [8] (ðŸ–©..ðŸ–°)    POCKET CALCULATOR..TWO BUTTON MOUSE
                                // E0.7   [2] (ðŸ–±ï¸..ðŸ–²ï¸)    computer mouse..trackball
                                // E0.0   [9] (ðŸ–³..ðŸ–»)    OLD PERSONAL COMPUTER..DOCUMENT WITH PICTURE
                                // E0.7   [1] (ðŸ–¼ï¸)       framed picture
                                // E0.0   [5] (ðŸ–½..ðŸ—)    FRAME WITH TILES..OPEN FOLDER
                                // E0.7   [3] (ðŸ—‚ï¸..ðŸ—„ï¸)    card index dividers..file cabinet
                                // E0.0  [12] (ðŸ—…..ðŸ—)    EMPTY NOTE..PAGES
                                // E0.7   [3] (ðŸ—‘ï¸..ðŸ—“ï¸)    wastebasket..spiral calendar
                                // E0.0   [8] (ðŸ—”..ðŸ—›)    DESKTOP WINDOW..DECREASE FONT SIZE SYMBOL
                                // E0.7   [3] (ðŸ—œï¸..ðŸ—žï¸)    clamp..rolled-up newspaper
                                // E0.0   [2] (ðŸ—Ÿ..ðŸ— )    PAGE WITH CIRCLED TEXT..STOCK CHART
                                // E0.7   [1] (ðŸ—¡ï¸)       dagger
                                // E0.0   [1] (ðŸ—¢)       LIPS
                                // E0.7   [1] (ðŸ—£ï¸)       speaking head
                                // E0.0   [4] (ðŸ—¤..ðŸ—§)    THREE RAYS ABOVE..THREE RAYS RIGHT
                                // E2.0   [1] (ðŸ—¨ï¸)       left speech bubble
                                // E0.0   [6] (ðŸ—©..ðŸ—®)    RIGHT SPEECH BUBBLE..LEFT ANGER BUBBLE
                                // E0.7   [1] (ðŸ—¯ï¸)       right anger bubble
                                // E0.0   [3] (ðŸ—°..ðŸ—²)    MOOD BUBBLE..LIGHTNING MOOD
                                // E0.7   [1] (ðŸ—³ï¸)       ballot box with ballot
                                // E0.0   [6] (ðŸ—´..ðŸ—¹)    BALLOT SCRIPT X..BALLOT BOX WITH BOLD CHECK
                                // E0.7   [1] (ðŸ—ºï¸)       world map
                                // E0.6   [5] (ðŸ—»..ðŸ—¿)    mount fuji..moai
                                // E1.0   [1] (ðŸ˜€)       grinning face
                                // E0.6   [6] (ðŸ˜..ðŸ˜†)    beaming face with smiling eyes..grinning squinting face
                                // E1.0   [2] (ðŸ˜‡..ðŸ˜ˆ)    smiling face with halo..smiling face with horns
                                // E0.6   [5] (ðŸ˜‰..ðŸ˜)    winking face..smiling face with heart-eyes
                                // E1.0   [1] (ðŸ˜Ž)       smiling face with sunglasses
                                // E0.6   [1] (ðŸ˜)       smirking face
                                // E0.7   [1] (ðŸ˜)       neutral face
                                // E1.0   [1] (ðŸ˜‘)       expressionless face
                                // E0.6   [3] (ðŸ˜’..ðŸ˜”)    unamused face..pensive face
                                // E1.0   [1] (ðŸ˜•)       confused face
                                // E0.6   [1] (ðŸ˜–)       confounded face
                                // E1.0   [1] (ðŸ˜—)       kissing face
                                // E0.6   [1] (ðŸ˜˜)       face blowing a kiss
                                // E1.0   [1] (ðŸ˜™)       kissing face with smiling eyes
                                // E0.6   [1] (ðŸ˜š)       kissing face with closed eyes
                                // E1.0   [1] (ðŸ˜›)       face with tongue
                                // E0.6   [3] (ðŸ˜œ..ðŸ˜ž)    winking face with tongue..disappointed face
                                // E1.0   [1] (ðŸ˜Ÿ)       worried face
                                // E0.6   [6] (ðŸ˜ ..ðŸ˜¥)    angry face..sad but relieved face
                                // E1.0   [2] (ðŸ˜¦..ðŸ˜§)    frowning face with open mouth..anguished face
                                // E0.6   [4] (ðŸ˜¨..ðŸ˜«)    fearful face..tired face
                                // E1.0   [1] (ðŸ˜¬)       grimacing face
                                // E0.6   [1] (ðŸ˜­)       loudly crying face
                                // E1.0   [2] (ðŸ˜®..ðŸ˜¯)    face with open mouth..hushed face
                                // E0.6   [4] (ðŸ˜°..ðŸ˜³)    anxious face with sweat..flushed face
                                // E1.0   [1] (ðŸ˜´)       sleeping face
                                // E0.6   [1] (ðŸ˜µ)       face with crossed-out eyes
                                // E1.0   [1] (ðŸ˜¶)       face without mouth
                                // E0.6  [10] (ðŸ˜·..ðŸ™€)    face with medical mask..weary cat
                                // E1.0   [4] (ðŸ™..ðŸ™„)    slightly frowning face..face with rolling eyes
                                // E0.6  [11] (ðŸ™…..ðŸ™)    person gesturing NO..folded hands
                                ...
                                if (code < 0x1f774) {
                                    // E0.6   [1] (ðŸš€)       rocket
                                    // E1.0   [2] (ðŸš..ðŸš‚)    helicopter..locomotive
                                    // E0.6   [3] (ðŸšƒ..ðŸš…)    railway car..bullet train
                                    // E1.0   [1] (ðŸš†)       train
                                    // E0.6   [1] (ðŸš‡)       metro
                                    // E1.0   [1] (ðŸšˆ)       light rail
                                    // E0.6   [1] (ðŸš‰)       station
                                    // E1.0   [2] (ðŸšŠ..ðŸš‹)    tram..tram car
                                    // E0.6   [1] (ðŸšŒ)       bus
                                    // E0.7   [1] (ðŸš)       oncoming bus
                                    // E1.0   [1] (ðŸšŽ)       trolleybus
                                    // E0.6   [1] (ðŸš)       bus stop
                                    // E1.0   [1] (ðŸš)       minibus
                                    // E0.6   [3] (ðŸš‘..ðŸš“)    ambulance..police car
                                    // E0.7   [1] (ðŸš”)       oncoming police car
                                    // E0.6   [1] (ðŸš•)       taxi
                                    // E1.0   [1] (ðŸš–)       oncoming taxi
                                    // E0.6   [1] (ðŸš—)       automobile
                                    // E0.7   [1] (ðŸš˜)       oncoming automobile
                                    // E0.6   [2] (ðŸš™..ðŸšš)    sport utility vehicle..delivery truck
                                    // E1.0   [7] (ðŸš›..ðŸš¡)    articulated lorry..aerial tramway
                                    // E0.6   [1] (ðŸš¢)       ship
                                    // E1.0   [1] (ðŸš£)       person rowing boat
                                    // E0.6   [2] (ðŸš¤..ðŸš¥)    speedboat..horizontal traffic light
                                    // E1.0   [1] (ðŸš¦)       vertical traffic light
                                    // E0.6   [7] (ðŸš§..ðŸš­)    construction..no smoking
                                    // E1.0   [4] (ðŸš®..ðŸš±)    litter in bin sign..non-potable water
                                    // E0.6   [1] (ðŸš²)       bicycle
                                    // E1.0   [3] (ðŸš³..ðŸšµ)    no bicycles..person mountain biking
                                    // E0.6   [1] (ðŸš¶)       person walking
                                    // E1.0   [2] (ðŸš·..ðŸš¸)    no pedestrians..children crossing
                                    // E0.6   [6] (ðŸš¹..ðŸš¾)    menâ€™s room..water closet
                                    // E1.0   [1] (ðŸš¿)       shower
                                    // E0.6   [1] (ðŸ›€)       person taking bath
                                    // E1.0   [5] (ðŸ›..ðŸ›…)    bathtub..left luggage
                                    // E0.0   [5] (ðŸ›†..ðŸ›Š)    TRIANGLE WITH ROUNDED CORNERS..GIRLS SYMBOL
                                    // E0.7   [1] (ðŸ›‹ï¸)       couch and lamp
                                    // E1.0   [1] (ðŸ›Œ)       person in bed
                                    // E0.7   [3] (ðŸ›ï¸..ðŸ›ï¸)    shopping bags..bed
                                    // E1.0   [1] (ðŸ›)       place of worship
                                    // E3.0   [2] (ðŸ›‘..ðŸ›’)    stop sign..shopping cart
                                    // E0.0   [2] (ðŸ›“..ðŸ›”)    STUPA..PAGODA
                                    // E12.0  [1] (ðŸ›•)       hindu temple
                                    // E13.0  [2] (ðŸ›–..ðŸ›—)    hut..elevator
                                    // E0.0   [4] (ðŸ›˜..ðŸ››)    <reserved-1F6D8>..<reserved-1F6DB>
                                    // E15.0  [1] (ðŸ›œ)       wireless
                                    // E14.0  [3] (ðŸ›..ðŸ›Ÿ)    playground slide..ring buoy
                                    // E0.7   [6] (ðŸ› ï¸..ðŸ›¥ï¸)    hammer and wrench..motor boat
                                    // E0.0   [3] (ðŸ›¦..ðŸ›¨)    UP-POINTING MILITARY AIRPLANE..UP-POINTING SMALL AIRPLANE
                                    // E0.7   [1] (ðŸ›©ï¸)       small airplane
                                    // E0.0   [1] (ðŸ›ª)       NORTHEAST-POINTING AIRPLANE
                                    // E1.0   [2] (ðŸ›«..ðŸ›¬)    airplane departure..airplane arrival
                                    // E0.0   [3] (ðŸ›­..ðŸ›¯)    <reserved-1F6ED>..<reserved-1F6EF>
                                    // E0.7   [1] (ðŸ›°ï¸)       satellite
                                    // E0.0   [2] (ðŸ›±..ðŸ›²)    ONCOMING FIRE ENGINE..DIESEL LOCOMOTIVE
                                    // E0.7   [1] (ðŸ›³ï¸)       passenger ship
                                    // E3.0   [3] (ðŸ›´..ðŸ›¶)    kick scooter..canoe
                                    // E5.0   [2] (ðŸ›·..ðŸ›¸)    sled..flying saucer
                                    // E11.0  [1] (ðŸ›¹)       skateboard
                                    // E12.0  [1] (ðŸ›º)       auto rickshaw
                                    // E13.0  [2] (ðŸ›»..ðŸ›¼)    pickup truck..roller skate
                                    // E0.0   [3] (ðŸ›½..ðŸ›¿)    <reserved-1F6FD>..<reserved-1F6FF>
                                    if (0x1f680 <= code && code <= 0x1f6ff) {
                                        return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                    }
                                }
                                else {
                                    // E0.0  [12] (ðŸ´..ðŸ¿)    LOT OF FORTUNE..ORCUS
                    ...
                    if (code < 0x1f8ae) {
                        if (code < 0x1f848) {
                            if (code < 0x1f80c) {
                                // E0.0  [11] (ðŸŸ•..ðŸŸŸ)    CIRCLED TRIANGLE..<reserved-1F7DF>
                                // E12.0 [12] (ðŸŸ ..ðŸŸ«)    orange circle..brown square
                                // E0.0   [4] (ðŸŸ¬..ðŸŸ¯)    <reserved-1F7EC>..<reserved-1F7EF>
                                // E14.0  [1] (ðŸŸ°)       heavy equals sign
                                // E0.0  [15] (ðŸŸ±..ðŸŸ¿)    <reserved-1F7F1>..<reserved-1F7FF>
                                if (0x1f7d5 <= code && code <= 0x1f7ff) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                            }
                            else {
                                // E0.0   [4] (ðŸ Œ..ðŸ )    <reserved-1F80C>..<reserved-1F80F>
                            ...
                            if (code < 0x1f85a) {
                                // E0.0   [8] (ðŸ¡ˆ..ðŸ¡)    <reserved-1F848>..<reserved-1F84F>
                                ...
                                if (code < 0x1f888) {
                                    // E0.0   [6] (ðŸ¡š..ðŸ¡Ÿ)    <reserved-1F85A>..<reserved-1F85F>
                                    if (0x1f85a <= code && code <= 0x1f85f) {
                                        return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                    }
                                }
                                else {
                                    // E0.0   [8] (ðŸ¢ˆ..ðŸ¢)    <reserved-1F888>..<reserved-1F88F>
                        ...
                        if (code < 0x1f93c) {
                            if (code < 0x1f90c) {
                                // E0.0  [82] (ðŸ¢®..ðŸ£¿)    <reserved-1F8AE>..<reserved-1F8FF>
                                if (0x1f8ae <= code && code <= 0x1f8ff) {
                                    return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                }
                            }
                            else {
                                // E13.0  [1] (ðŸ¤Œ)       pinched fingers
                                // E12.0  [3] (ðŸ¤..ðŸ¤)    white heart..pinching hand
                                // E1.0   [9] (ðŸ¤..ðŸ¤˜)    zipper-mouth face..sign of the horns
                                // E3.0   [6] (ðŸ¤™..ðŸ¤ž)    call me hand..crossed fingers
                                // E5.0   [1] (ðŸ¤Ÿ)       love-you gesture
                                // E3.0   [8] (ðŸ¤ ..ðŸ¤§)    cowboy hat face..sneezing face
                                // E5.0   [8] (ðŸ¤¨..ðŸ¤¯)    face with raised eyebrow..exploding head
                                // E3.0   [1] (ðŸ¤°)       pregnant woman
                                // E5.0   [2] (ðŸ¤±..ðŸ¤²)    breast-feeding..palms up together
                                // E3.0   [8] (ðŸ¤³..ðŸ¤º)    selfie..person fencing
                            ...
                            if (code < 0x1f947) {
                                // E3.0   [3] (ðŸ¤¼..ðŸ¤¾)    people wrestling..person playing handball
                                // E12.0  [1] (ðŸ¤¿)       diving mask
                                // E3.0   [6] (ðŸ¥€..ðŸ¥…)    wilted flower..goal net
                                ...
                                if (code < 0x1fc00) {
                                    // E3.0   [5] (ðŸ¥‡..ðŸ¥‹)    1st place medal..martial arts uniform
                                    // E5.0   [1] (ðŸ¥Œ)       curling stone
                                    // E11.0  [3] (ðŸ¥..ðŸ¥)    lacrosse..flying disc
                                    // E3.0  [15] (ðŸ¥..ðŸ¥ž)    croissant..pancakes
                                    // E5.0  [13] (ðŸ¥Ÿ..ðŸ¥«)    dumpling..canned food
                                    // E11.0  [5] (ðŸ¥¬..ðŸ¥°)    leafy green..smiling face with hearts
                                    // E12.0  [1] (ðŸ¥±)       yawning face
                                    // E13.0  [1] (ðŸ¥²)       smiling face with tear
                                    // E11.0  [4] (ðŸ¥³..ðŸ¥¶)    partying face..cold face
                                    // E13.0  [2] (ðŸ¥·..ðŸ¥¸)    ninja..disguised face
                                    // E14.0  [1] (ðŸ¥¹)       face holding back tears
                                    // E11.0  [1] (ðŸ¥º)       pleading face
                                    // E12.0  [1] (ðŸ¥»)       sari
                                    // E11.0  [4] (ðŸ¥¼..ðŸ¥¿)    lab coat..flat shoe
                                    // E1.0   [5] (ðŸ¦€..ðŸ¦„)    crab..unicorn
                                    // E3.0  [13] (ðŸ¦…..ðŸ¦‘)    eagle..squid
                                    // E5.0   [6] (ðŸ¦’..ðŸ¦—)    giraffe..cricket
                                    // E11.0 [11] (ðŸ¦˜..ðŸ¦¢)    kangaroo..swan
                                    // E13.0  [2] (ðŸ¦£..ðŸ¦¤)    mammoth..dodo
                                    // E12.0  [6] (ðŸ¦¥..ðŸ¦ª)    sloth..oyster
                                    // E13.0  [3] (ðŸ¦«..ðŸ¦­)    beaver..seal
                                    // E12.0  [2] (ðŸ¦®..ðŸ¦¯)    guide dog..white cane
                                    // E11.0 [10] (ðŸ¦°..ðŸ¦¹)    red hair..supervillain
                                    // E12.0  [6] (ðŸ¦º..ðŸ¦¿)    safety vest..mechanical leg
                                    // E1.0   [1] (ðŸ§€)       cheese wedge
                                    // E11.0  [2] (ðŸ§..ðŸ§‚)    cupcake..salt
                                    // E12.0  [8] (ðŸ§ƒ..ðŸ§Š)    beverage box..ice
                                    // E13.0  [1] (ðŸ§‹)       bubble tea
                                    // E14.0  [1] (ðŸ§Œ)       troll
                                    // E12.0  [3] (ðŸ§..ðŸ§)    person standing..deaf person
                                    // E5.0  [23] (ðŸ§..ðŸ§¦)    face with monocle..socks
                                    // E11.0 [25] (ðŸ§§..ðŸ§¿)    red envelope..nazar amulet
                                    // E0.0 [112] (ðŸ¨€..ðŸ©¯)    NEUTRAL CHESS KING..<reserved-1FA6F>
                                    // E12.0  [4] (ðŸ©°..ðŸ©³)    ballet shoes..shorts
                                    // E13.0  [1] (ðŸ©´)       thong sandal
                                    // E15.0  [3] (ðŸ©µ..ðŸ©·)    light blue heart..pink heart
                                    // E12.0  [3] (ðŸ©¸..ðŸ©º)    drop of blood..stethoscope
                                    // E14.0  [2] (ðŸ©»..ðŸ©¼)    x-ray..crutch
                                    // E0.0   [3] (ðŸ©½..ðŸ©¿)    <reserved-1FA7D>..<reserved-1FA7F>
                                    // E12.0  [3] (ðŸª€..ðŸª‚)    yo-yo..parachute
                                    // E13.0  [4] (ðŸªƒ..ðŸª†)    boomerang..nesting dolls
                                    // E15.0  [2] (ðŸª‡..ðŸªˆ)    maracas..flute
                                    // E0.0   [7] (ðŸª‰..ðŸª)    <reserved-1FA89>..<reserved-1FA8F>
                                    // E12.0  [6] (ðŸª..ðŸª•)    ringed planet..banjo
                                    // E13.0 [19] (ðŸª–..ðŸª¨)    military helmet..rock
                                    // E14.0  [4] (ðŸª©..ðŸª¬)    mirror ball..hamsa
                                    // E15.0  [3] (ðŸª­..ðŸª¯)    folding hand fan..khanda
                                    // E13.0  [7] (ðŸª°..ðŸª¶)    fly..feather
                                    // E14.0  [4] (ðŸª·..ðŸªº)    lotus..nest with eggs
                                    // E15.0  [3] (ðŸª»..ðŸª½)    hyacinth..wing
                                    // E0.0   [1] (ðŸª¾)       <reserved-1FABE>
                                    // E15.0  [1] (ðŸª¿)       goose
                                    // E13.0  [3] (ðŸ«€..ðŸ«‚)    anatomical heart..people hugging
                                    // E14.0  [3] (ðŸ«ƒ..ðŸ«…)    pregnant man..person with crown
                                    // E0.0   [8] (ðŸ«†..ðŸ«)    <reserved-1FAC6>..<reserved-1FACD>
                                    // E15.0  [2] (ðŸ«Ž..ðŸ«)    moose..donkey
                                    // E13.0  [7] (ðŸ«..ðŸ«–)    blueberries..teapot
                                    // E14.0  [3] (ðŸ«—..ðŸ«™)    pouring liquid..jar
                                    // E15.0  [2] (ðŸ«š..ðŸ«›)    ginger root..pea pod
                                    // E0.0   [4] (ðŸ«œ..ðŸ«Ÿ)    <reserved-1FADC>..<reserved-1FADF>
                                    // E14.0  [8] (ðŸ« ..ðŸ«§)    melting face..bubbles
                                    // E15.0  [1] (ðŸ«¨)       shaking face
                                    // E0.0   [7] (ðŸ«©..ðŸ«¯)    <reserved-1FAE9>..<reserved-1FAEF>
                                    // E14.0  [7] (ðŸ«°..ðŸ«¶)    hand with index finger and thumb crossed..heart hands
                                    // E15.0  [2] (ðŸ«·..ðŸ«¸)    leftwards pushing hand..rightwards pushing hand
                                    // E0.0   [7] (ðŸ«¹..ðŸ«¿)    <reserved-1FAF9>..<reserved-1FAFF>
                                    if (0x1f947 <= code && code <= 0x1faff) {
                                        return boundaries_1.EXTENDED_PICTOGRAPHIC;
                                    }
                                }
                                else {
                                    // E0.0[1022] (ðŸ°€..ðŸ¿½)    <reserved-1FC00>..<reserved-1FFFD>
