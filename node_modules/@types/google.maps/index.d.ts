...
declare namespace google.maps.geometry.spherical {
  /**
   * Returns the unsigned area of a closed path, in the range [0, 2Ã—piÃ—radiusÂ²].
   ...
   * positive, in the range [-2Ã—piÃ—radiusÂ², 2Ã—piÃ—radiusÂ²]. The computed area
...
declare namespace google.maps.places {
  ...
  export class OpeningHoursPoint {
     ...
     * This will be reported in the Placeâ€™s time zone.
     */
    hour: number;
    /**
     * The minute of the OpeningHoursPoint.time as a number, in the range [0,
     * 59]. This will be reported in the Placeâ€™s time zone.
     */
    minute: number;
  }
  /**
  ...
  export class Place {
    ...
    /**
     * The collection of address components for this Placeâ€™s location. Empty
    ...
    /**
     * The representation of the Placeâ€™s address in the <a
    ...
    id: string;
    /**
     * The Placeâ€™s phone number in international format. International format
    ...
    location?: google.maps.LatLng | null;
    /**
     * The Placeâ€™s phone number, formatted according to the <a
    ...
    types?: string[];
    /**
     * The number of user ratings which contributed to this Placeâ€™s {@link
  ...
  export interface PlaceOpeningHoursTime {
     ...
     * reported in the Placeâ€™s time zone.
     */
    hours: number;
    /**
  ...
  export interface PlaceResult {
    /**
     * The collection of address components for this Placeâ€™s location. Only
    ...
    /**
     * The Placeâ€™s geometry-related information.
     */
    ...
    html_attributions?: string[];
    /**
     * URL to an image resource that can be used to represent this Placeâ€™s
     * category.
     */
    icon?: string;
    /**
    ...
    /**
     * The Placeâ€™s name. Note: In the case of user entered Places, this is the
