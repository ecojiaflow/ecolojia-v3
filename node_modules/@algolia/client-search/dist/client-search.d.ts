...
export declare type AddApiKeyOptions = {
    ...
    /**
     * Specify the list of targeted indices. You can target all indices starting with a prefix or ending with a suffix using the â€˜*â€™ character.
     */
    readonly indexes?: readonly string[];
    /**
     * Specify the list of referers. You can target all referers starting with a prefix, ending with a suffix using the â€˜*â€™ character.
     */
...
export declare type Log = {
    ...
    /**
     * Request body. Itâ€™s truncated after 1000 characters.
     */
    readonly query_body: string;
    /**
     * Answer body. Itâ€™s truncated after 1000 characters.
     */
...
export declare type SearchOptions = {
    ...
    /**
     * Whether to allow typos on numbers (â€œnumeric tokensâ€) in the query string.
     */
    ...
    /**
     * Selects a strategy to remove words from the query when it doesnâ€™t match any hits.
     */
    ...
    /**
     * Whether to take into account an indexâ€™s synonyms for a particular search.
     */
    ...
    /**
     * Enriches the APIâ€™s response with meta-information as to how the query was processed.
     */
...
export declare type Settings = {
    ...
    /**
     * hether to allow typos on numbers (â€œnumeric tokensâ€) in the query string.
     */
    readonly allowTyposOnNumericTokens?: boolean;
    /**
     * List of attributes on which you want to disable typo tolerance.
    ...
    /**
     * Specify on which attributes in your index Algolia should apply word-splitting (â€œdecompoundingâ€)
     */
