...
describe("Decode test", () => {
    ...
    it("should HTML decode partial legacy entity", () => {
        ...
        expect(entities.decodeHTML("&timesbar")).toBe("Ã—bar");
    });

    it("should HTML decode legacy entities according to spec", () =>
        expect(entities.decodeHTML("?&image_uri=1&â„‘=2&image=3")).toBe(
            "?&image_uri=1&â„‘=2&image=3",
        ));
    ...
    it("should decode trailing legacy entities", () => {
        expect(entities.decodeHTML("&timesbar;&timesbar")).toBe("â¨±Ã—bar");
    });

    it("should decode multi-byte entities", () => {
        expect(entities.decodeHTML("&NotGreaterFullEqual;")).toBe("â‰§Ì¸");
    });
