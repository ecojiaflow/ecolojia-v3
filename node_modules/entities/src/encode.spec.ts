...
describe("Encode->decode test", () => {
    ...
    for (const { input, xml, html } of testcases) {
        ...
        it("should encode emojis", () =>
            expect(entities.encodeHTML5("ðŸ˜„ðŸ¾ðŸ¥³ðŸ’¥ðŸ˜‡")).toBe(
                "&#x1f604;&#x1f37e;&#x1f973;&#x1f4a5;&#x1f607;",
            ));
    }
...
describe("encodeNonAsciiHTML", () => {
    ...
    it("should encode emojis", () =>
        expect(entities.encodeNonAsciiHTML("ðŸ˜„ðŸ¾ðŸ¥³ðŸ’¥ðŸ˜‡")).toBe(
            "&#x1f604;&#x1f37e;&#x1f973;&#x1f4a5;&#x1f607;",
        ));

    it("should encode chars above surrogates", () =>
        expect(entities.encodeNonAsciiHTML("â™’ï¸â™“ï¸â™ˆï¸â™‰ï¸â™Šï¸â™‹ï¸â™Œï¸â™ï¸â™Žï¸â™ï¸â™ï¸â™‘ï¸")).toBe(
