...
export namespace SVGPathDataTransformer {
  ...
  /*
   * A quadratic bÃ©zier curve can be represented by a cubic bÃ©zier curve which has
  ...
  export function CALCULATE_BOUNDS() {
    ...
    const f: TransformFunction & {minX: number, maxX: number, minY: number, maxY: number} =
      ...
      if (c.type & SVGPathData.ARC) {
        ...
        // points on ellipse for phi = 0Â° and phi = 90Â°
        ...
        // annotateArcCommand returns phi1 and phi2 such that -180Â° < phi1 < 180Â° and phi2 is smaller or greater
        // depending on the sweep flag. Calculate phiMin, phiMax such that -180Â° < phiMin < 180Â° and phiMin < phiMax
