  ...
  function newFormat(specifier) {
    ...
    function format(value) {
      ...
      if (type === "c") {
        ...
        valueSuffix = (type === "s" ? prefixes[8 + _formatPrefixAuto.prefixExponent / 3] : "") + valueSuffix + (valueNegative && sign === "(" ? ")" : ""); // Break the formatted value into the integer â€œvalueâ€ part that can be
