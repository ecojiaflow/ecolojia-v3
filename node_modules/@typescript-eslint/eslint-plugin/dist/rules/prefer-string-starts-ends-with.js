...
exports.default = (0, util_1.createRule)({
    ...
    create(context) {
         ...
         *   E.g., `foo` â†’ `foo.length` / `"foo"` â†’ `"foo".length`
         ...
         *
         * - `obj[foo]` â†’ the range of `[foo]`
         * - `obf.foo` â†’ the range of `.foo`
         * - `(obj).foo` â†’ the range of `.foo`
         *
         ...
         * For example: `foo.slice(0, 3) === 'bar'` â†’ `foo.startsWith('bar')`
         ...
         * For example: `foo.indexOf('bar') === 0` â†’ `foo.startsWith('bar')`
         * @param fixer The rule fixer.
         * @param node The node which was reported.
         * @param kind The kind of the report.
