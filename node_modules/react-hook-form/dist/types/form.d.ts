 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/register) â€¢ [Demo](https://codesandbox.io/s/react-hook-form-register-ts-ip2j3) â€¢ [Video](https://www.youtube.com/watch?v=JFIpCoajYkA)
 *
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/setfocus) â€¢ [Demo](https://codesandbox.io/s/setfocus-rolus)
 *
...
export type UseFormGetValues<TFieldValues extends FieldValues> = {
     ...
     *
     * @remarks
     * [API](https://react-hook-form.com/docs/useform/getvalues) â€¢ [Demo](https://codesandbox.io/s/react-hook-form-v7-ts-getvalues-txsfg)
     *
     * @returns form values
     *
     * @example
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/getfieldstate) â€¢ [Demo](https://codesandbox.io/s/getfieldstate-jvekk)
 *
 * @param name - the path name to the form field value.
 *
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/subscribe) â€¢ [Demo](https://codesandbox.io/s/subscribe)
 *
...
export type UseFormWatch<TFieldValues extends FieldValues> = {
     ...
     *
     * @remarks
     * [API](https://react-hook-form.com/docs/useform/watch) â€¢ [Demo](https://codesandbox.io/s/react-hook-form-watch-v7-ts-8et1d) â€¢ [Video](https://www.youtube.com/watch?v=3qLd69WMqKk)
     *
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/trigger) â€¢ [Demo](https://codesandbox.io/s/react-hook-form-v7-ts-triggervalidation-forked-xs7hl) â€¢ [Video](https://www.youtube.com/watch?v=-bcyJCDjksE)
 *
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/clearerrors) â€¢ [Demo](https://codesandbox.io/s/react-hook-form-v7-ts-clearerrors-w3ymx)
 *
 * @param name - the path name to the form field value.
 *
 * @example
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/setvalue) â€¢ [Demo](https://codesandbox.io/s/react-hook-form-v7-ts-setvalue-8z9hx) â€¢ [Video](https://www.youtube.com/watch?v=qpv51sCH3fI)
 *
 * @param name - the path name to the form field value.
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/seterror) â€¢ [Demo](https://codesandbox.io/s/react-hook-form-v7-ts-seterror-nfxxu) â€¢ [Video](https://www.youtube.com/watch?v=raMqvE0YyIY)
 *
 * @param name - the path name to the form field value.
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/unregister) â€¢ [Demo](https://codesandbox.io/s/react-hook-form-unregister-4k2ey) â€¢ [Video](https://www.youtube.com/watch?v=TM99g_NW5Gk&feature=emb_imp_woyt)
 *
 * @param name - the path name to the form field value.
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/handlesubmit) â€¢ [Demo](https://codesandbox.io/s/react-hook-form-handlesubmit-ts-v7-lcrtu) â€¢ [Video](https://www.youtube.com/watch?v=KzcPKB9SOEk)
 *
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/resetfield) â€¢ [Demo](https://codesandbox.io/s/priceless-firefly-d0kuv) â€¢ [Video](https://www.youtube.com/watch?v=IdLFcNaEFEo)
 *
 * @param name - the path name to the form field value.
 * @param options - keep form state options
 *
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/reset) â€¢ [Demo](https://codesandbox.io/s/react-hook-form-reset-v7-ts-pu901) â€¢ [Video](https://www.youtube.com/watch?v=qmCLBjyPwVk)
 *
