...
var matchMonthPatterns = {
  narrow: /^[svkbglr]/i,
  abbreviated: /^(saus\.|vas\.|kov\.|bal\.|geg\.|birÅ¾\.|liep\.|rugp\.|rugs\.|spal\.|lapkr\.|gruod\.)/i,
...
var matchDayPeriodPatterns = {
  narrow: /^(pr.\s?p.|pop.|vidurnaktis|(vidurdienis|perpiet)|rytas|(diena|popietÄ—)|vakaras|naktis)/i,
