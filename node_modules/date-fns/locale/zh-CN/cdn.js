...
var matchOrdinalNumberPattern = /^(ç¬¬\s*)?\d+(æ—¥|æ—¶|åˆ†|ç§’)?/i;
...
var matchQuarterPatterns = {
  narrow: /^[1234]/i,
  abbreviated: /^ç¬¬[ä¸€äºŒä¸‰å››]åˆ»/i,
  wide: /^ç¬¬[ä¸€äºŒä¸‰å››]åˆ»é’Ÿ/i
};
...
var matchMonthPatterns = {
  ...
  abbreviated: /^(ä¸€|äºŒ|ä¸‰|å››|äº”|å…­|ä¸ƒ|å…«|ä¹|å[äºŒä¸€]|\d|1[12])æœˆ/i,
