...
var matchMonthPatterns = {
  ...
  abbreviated: /^(Ñ˜Ð°Ð½|Ñ„ÐµÐ±|Ð¼Ð°Ñ€|Ð°Ð¿Ñ€|Ð¼Ð°Ñ˜|Ñ˜ÑƒÐ½|Ñ˜ÑƒÐ»|Ð°Ð²Ð³|ÑÐµÐ¿|Ð¾ÐºÑ‚|Ð½Ð¾Ð²|Ð´ÐµÑ†)/i,
...
var parseDayPatterns = {
  narrow: [/^Ð¿/i, /^Ñƒ/i, /^Ñ/i, /^Ñ‡/i, /^Ð¿/i, /^Ñ/i, /^Ð½/i],
  any: [/^Ð½ÐµÐ´/i, /^Ð¿Ð¾Ð½/i, /^ÑƒÑ‚Ð¾/i, /^ÑÑ€Ðµ/i, /^Ñ‡ÐµÑ‚/i, /^Ð¿ÐµÑ‚/i, /^ÑÑƒÐ±/i]
};
