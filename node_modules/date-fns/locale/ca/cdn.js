...
var matchOrdinalNumberPattern = /^(\d+)(Ã¨|r|n|r|t)?/i;
...
var matchMonthPatterns = {
  ...
  abbreviated: /^(gen.|febr.|marÃ§|abr.|maig|juny|jul.|ag.|set.|oct.|nov.|des.)/i,
...
var matchDayPeriodPatterns = {
  ...
  abbreviated: /^([ap]\.?\s?m\.?|mitjanit|migdia|(del|de la) (matÃ­|tarda|vespre|nit))/i,
