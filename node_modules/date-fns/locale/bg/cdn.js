...
var matchOrdinalNumberPattern = /^(\d+)(-?[Ð²Ñ€Ð¼Ñ‚][Ð°Ð¸]|-?Ñ‚?(ÐµÐ½|Ð½Ð°)|-?(ÐµÐ²|ÐµÐ²Ð°))?/i;
...
var parseDayPatterns = {
  ...
  any: [/^Ð½[ÐµÐ´]/i, /^Ð¿[Ð¾Ð½]/i, /^Ð²Ñ‚/i, /^ÑÑ€/i, /^Ñ‡[ÐµÑ‚]/i, /^Ð¿[ÐµÑ‚]/i, /^Ñ[ÑŠÐ±]/i]
};
var matchMonthPatterns = {
  abbreviated: /^(ÑÐ½Ñƒ|Ñ„ÐµÐ²|Ð¼Ð°Ñ€|Ð°Ð¿Ñ€|Ð¼Ð°Ð¹|ÑŽÐ½Ð¸|ÑŽÐ»Ð¸|Ð°Ð²Ð³|ÑÐµÐ¿|Ð¾ÐºÑ‚|Ð½Ð¾Ðµ|Ð´ÐµÐº)/i,
