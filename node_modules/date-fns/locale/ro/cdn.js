...
var matchEraPatterns = {
  narrow: /^(ÃŽ|D)/i,
  abbreviated: /^(ÃŽ\.?\s?d\.?\s?C\.?|ÃŽ\.?\s?e\.?\s?n\.?|D\.?\s?C\.?|e\.?\s?n\.?)/i,
  wide: /^(ÃŽnainte de Cristos|ÃŽnaintea erei noastre|DupÄƒ Cristos|Era noastrÄƒ)/i
};
var parseEraPatterns = {
  any: [/^ÃŽC/i, /^DC/i],
  wide: [
  /^(ÃŽnainte de Cristos|ÃŽnaintea erei noastre)/i,
...
var matchDayPatterns = {
  ...
  wide: /^(duminica|luni|marÅ£i|miercuri|joi|vineri|sÃ¢mbÄƒtÄƒ)/i
};
