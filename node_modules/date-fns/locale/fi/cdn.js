...
function futureDays(text) {
  return text.replace(/pÃ¤ivÃ¤Ã¤?/, "p\xE4iv\xE4n");
}
...
var matchMonthPatterns = {
  narrow: /^[thmkeslj]/i,
  abbreviated: /^(tammi|helmi|maalis|huhti|touko|kesÃ¤|heinÃ¤|elo|syys|loka|marras|joulu)/i,
...
var matchDayPeriodPatterns = {
  narrow: /^(ap|ip|keskiyÃ¶|keskipÃ¤ivÃ¤|aamupÃ¤ivÃ¤llÃ¤|iltapÃ¤ivÃ¤llÃ¤|illalla|yÃ¶llÃ¤)/i,
