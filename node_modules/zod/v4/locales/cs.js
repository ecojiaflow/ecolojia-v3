        ...
        switch (issue.code) {
            ...
            case "invalid_value":
                if (issue.values.length === 1)
                    return `NeplatnÃ½ vstup: oÄekÃ¡vÃ¡no ${util.stringifyPrimitive(issue.values[0])}`;
            ...
            case "invalid_format": {
                ...
                if (_issue.format === "starts_with")
                    return `NeplatnÃ½ Å™etÄ›zec: musÃ­ zaÄÃ­nat na "${_issue.prefix}"`;
                if (_issue.format === "ends_with")
                    return `NeplatnÃ½ Å™etÄ›zec: musÃ­ konÄit na "${_issue.suffix}"`;
