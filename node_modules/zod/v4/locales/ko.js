        ...
        switch (issue.code) {
            ...
            case "invalid_format": {
                ...
                if (_issue.format === "ends_with")
                    return `ìž˜ëª»ëœ ë¬¸ìžì—´: "${_issue.suffix}"(ìœ¼)ë¡œ ëë‚˜ì•¼ í•©ë‹ˆë‹¤`;
                if (_issue.format === "includes")
                    return `ìž˜ëª»ëœ ë¬¸ìžì—´: "${_issue.includes}"ì„(ë¥¼) í¬í•¨í•´ì•¼ í•©ë‹ˆë‹¤`;
                if (_issue.format === "regex")
                    return `ìž˜ëª»ëœ ë¬¸ìžì—´: ì •ê·œì‹ ${_issue.pattern} íŒ¨í„´ê³¼ ì¼ì¹˜í•´ì•¼ í•©ë‹ˆë‹¤`;
