        ...
        switch (issue.code) {
            ...
            case "invalid_value":
                if (issue.values.length === 1)
                    return `ç„¡åŠ¹ãªå…¥åŠ›: ${util.stringifyPrimitive(issue.values[0])}ãŒæœŸå¾…ã•ã‚Œã¾ã—ãŸ`;
            ...
            case "invalid_format": {
                ...
                if (_issue.format === "starts_with")
                    return `ç„¡åŠ¹ãªæ–‡å­—åˆ—: "${_issue.prefix}"ã§å§‹ã¾ã‚‹å¿…è¦ãŒã‚ã‚Šã¾ã™`;
                if (_issue.format === "ends_with")
                    return `ç„¡åŠ¹ãªæ–‡å­—åˆ—: "${_issue.suffix}"ã§çµ‚ã‚ã‚‹å¿…è¦ãŒã‚ã‚Šã¾ã™`;
                if (_issue.format === "includes")
                    return `ç„¡åŠ¹ãªæ–‡å­—åˆ—: "${_issue.includes}"ã‚’å«ã‚€å¿…è¦ãŒã‚ã‚Šã¾ã™`;
                if (_issue.format === "regex")
                    return `ç„¡åŠ¹ãªæ–‡å­—åˆ—: ãƒ‘ã‚¿ãƒ¼ãƒ³${_issue.pattern}ã«ä¸€è‡´ã™ã‚‹å¿…è¦ãŒã‚ã‚Šã¾ã™`;
