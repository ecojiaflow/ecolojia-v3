        ...
        switch (issue.code) {
            ...
            case "invalid_value":
                if (issue.values.length === 1)
                    return `ç„¡æ•ˆçš„è¼¸å…¥å€¼ï¼šé æœŸç‚º ${util.stringifyPrimitive(issue.values[0])}`;
            ...
            case "invalid_format": {
                ...
                if (_issue.format === "ends_with")
                    return `ç„¡æ•ˆçš„å­—ä¸²ï¼šå¿…é ˆä»¥ "${_issue.suffix}" çµå°¾`;
                if (_issue.format === "includes")
                    return `ç„¡æ•ˆçš„å­—ä¸²ï¼šå¿…é ˆåŒ…å« "${_issue.includes}"`;
                if (_issue.format === "regex")
                    return `ç„¡æ•ˆçš„å­—ä¸²ï¼šå¿…é ˆç¬¦åˆæ ¼å¼ ${_issue.pattern}`;
