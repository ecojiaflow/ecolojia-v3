        ...
        switch (issue.code) {
            ...
            case "invalid_value":
                if (issue.values.length === 1)
                    return `ØºÙ„Ø· Ø§Ù† Ù¾Ù¹: ${util.stringifyPrimitive(issue.values[0])} Ù…ØªÙˆÙ‚Ø¹ ØªÚ¾Ø§`;
            ...
            case "invalid_format": {
                ...
                if (_issue.format === "ends_with")
                    return `ØºÙ„Ø· Ø³Ù¹Ø±Ù†Ú¯: "${_issue.suffix}" Ù¾Ø± Ø®ØªÙ… ÛÙˆÙ†Ø§ Ú†Ø§ÛÛŒÛ’`;
                if (_issue.format === "includes")
                    return `ØºÙ„Ø· Ø³Ù¹Ø±Ù†Ú¯: "${_issue.includes}" Ø´Ø§Ù…Ù„ ÛÙˆÙ†Ø§ Ú†Ø§ÛÛŒÛ’`;
                if (_issue.format === "regex")
                    return `ØºÙ„Ø· Ø³Ù¹Ø±Ù†Ú¯: Ù¾ÛŒÙ¹Ø±Ù† ${_issue.pattern} Ø³Û’ Ù…ÛŒÚ† ÛÙˆÙ†Ø§ Ú†Ø§ÛÛŒÛ’`;
