...
if (process.env.NODE_ENV !== 'production') {
    ...
    logger.log(`ðŸ“– Read the guides and documentation\n` +
        `${padding}https://developers.google.com/web/tools/workbox/`);
    logger.log(`â“ Use the [workbox] tag on Stack Overflow to ask questions\n` +
        `${padding}https://stackoverflow.com/questions/ask?tags=workbox`);
    logger.log(`ðŸ› Found a bug? Report it on GitHub\n` +
