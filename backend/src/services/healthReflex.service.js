...
function calculateHealthReflex(product) {
  ...
  // ============================================================================
  // CONTENU RÉFLEXE (phrase unique)
  // ============================================================================
  const reflexContents = {
    1: 'Ce produit peut s\'intégrer dans une alimentation équilibrée.',
    2: 'Pour ta santé, l\'idéal est de limiter ce type de produit au quotidien.',
    3: sublevel === 'limit_strongly' 
      ? 'Pour ta santé, l\'idéal est de limiter fortement ce type de produit.'
      : 'Pour ta santé, l\'idéal est de réserver ce produit aux occasions.'
  };
