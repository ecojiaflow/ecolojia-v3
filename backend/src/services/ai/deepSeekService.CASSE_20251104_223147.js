...
// 📄 CACHE VERSION
const CACHE_VERSION = 'v3.7'; // v3.7: Instructions OBLIGATOIRES novaGroup + nutriScore + additives
...
FORMAT JSON OBLIGATOIRE :
{
  ...
  "novaGroup": number (1-4, OBLIGATOIRE - analyse le nom/ingrédients),
  "nutriScore": "A|B|C|D|E" (OBLIGATOIRE - calcule depuis nutriments),
  "additives": ["E330", "E120"] (liste codes E détectés),
  "ecoScore": "A|B|C|D|E" (OBLIGATOIRE - estime impact environnemental),
  "product_info": {
    "product_name": "string (nom estimé du produit)",
    "brands": "string (marque estimée)"
  },
  "confidence": {
    "global": number (0-100),
    "per_nutrient": {
...
Liste INCI: ${productData.inci || productData.cosmeticsData?.inci || productData.ingredients_text || productData.ingredients || productData.composition || 'Non fournie'}
...
IMPORTANT : Renvoie aussi product_name et brands (estimés si absents).

🚨 RÈGLE CRITIQUE : Dans le JSON, tu DOIS TOUJOURS inclure un objet "product_info" avec :
   - "product_name": nom estimé du produit (analyse les ingrédients pour deviner)
   - "brands": marque estimée (déduis de la catégorie ou mets "Marque inconnue")
...
// IMPORTANT : Le JSON DOIT TOUJOURS contenir :
// - "novaGroup": 1|2|3|4 (estime depuis ingrédients/nom)
// - "nutriScore": "A"|"B"|"C"|"D"|"E" (calcule depuis nutriments)
// - "additives": ["E330",...] (liste codes E détectés dans ingrédients)
- "ecoScore": "A"|"B"|"C"|"D"|"E" (estime impact environnemental)
- "product_info": { "product_name": "...", "brands": "..." }
