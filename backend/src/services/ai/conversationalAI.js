...
class ConversationalAI {
  constructor() {
    ...
    this.memory = new Map();
    this.LIMIT = 20; // max tours conserves
  }
  ...
  async chat(userMsg, context = {}, session = uuidv4()) {
    ...
    /* Prompt systeme */
    const system = 'Tu es ECOLOJIA, expert nutrition, cosmetique et detergence. ' +
                   'Reponds brievement, en francais, avec des sources credibles.';
