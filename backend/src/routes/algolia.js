...
const algoliasearch = require('algoliasearch').default.default; // Ã¢Å“â€¦ Correction de l'import pour v5
...
router.get('/', (req, res) => {
  res.json({
    ...
    status: 'operational',
    endpoints: [
      'POST /sync - Synchroniser produits vers Algolia',
      'GET /search?q=... - Rechercher produits'
    ],
