        ...
        try {
          ...
          if (category === 'food') {
            newScores = calculateFoodScores({
              ...
              nutrition: {
                per100g: {
                  sugars: product.foodData?.nutrition?.per100g?.sugars || product.nutriments?.sugars_100g || 0,
                  salt: product.foodData?.nutrition?.per100g?.salt || product.nutriments?.salt_100g || 0,
                  saturatedFat: product.foodData?.nutrition?.per100g?.saturatedFat || product.nutriments?.['saturated-fat_100g'] || 0,
                  energy: product.foodData?.nutrition?.per100g?.energy || product.nutriments?.['energy-kcal_100g'] || 0,
                  fiber: product.foodData?.nutrition?.per100g?.fiber || product.nutriments?.fiber_100g || 0,
                  protein: product.foodData?.nutrition?.per100g?.protein || product.nutriments?.proteins_100g || 0
                }
              },
